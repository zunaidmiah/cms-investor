...
class IndexController extends \BaseController {
	...
	public function dodestroy($id)
	{
       ...
       public function getDownload()
        ...
        {
            $page_title="Corporate Profile:: OCK Group Berhad";
        ...
        {
            $page_title="Vision &amp; Mission:: OCK Group Berhad";
