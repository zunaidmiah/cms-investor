...
//bursa sub pages
  ...
  else if(Request::segment(3)=='sustainabilitypolicy')
  {
    $id =158;
  }      
...
Route::get('admin/sustainabilitypolicy', 'CorporateController@SustainabilityPolicy');
...
Route::resource('investorrelations/managementanalysis/sustainabilitypolicy', 'CorporateController@frontSustainabilityPolicy');
