       ...
       public function Add()
          {
            ...
            // print "<pre>";print_r(Input::all());exit("checing..");
        ...
        $banner->pdf5       = Input::file('pdf5');
        $banner->pdf6       = Input::file('pdf6');
        $banner->pdf7       = Input::file('pdf7');
        $banner->pdf8       = Input::file('pdf8');
        $banner->pdf9       = Input::file('pdf9');
        $banner->pdf10      = Input::file('pdf10');
        $pdf11_file = Input::file('pdf11');
        $pdf11_labelname = Input::get('pdf11_name');
        if(!empty($pdf11_file)){
          $banner->pdf11    = Input::file('pdf11');
          if(!empty($pdf11_labelname))
            $banner->pdf11_name = $pdf11_labelname;
        }
        $pdf12_file = Input::file('pdf12');
        $pdf12_labelname = Input::get('pdf12_name');
        if(!empty($pdf12_file)){
          $banner->pdf12      = Input::file('pdf12');
          if(!empty($pdf12_labelname))
            $banner->pdf12_name = Input::get('pdf12_name');
        }
        $pdf13_file = Input::file('pdf13');
        $pdf13_labelname = Input::get('pdf13_name');
        if(!empty($pdf13_file)){
          $banner->pdf13      = Input::file('pdf13');
          if(!empty($pdf13_labelname))
            $banner->pdf13_name = Input::get('pdf13_name');
        }
        $pdf14_file = Input::file('pdf14');
        $pdf14_labelname = Input::get('pdf14_name');
        if(!empty($pdf14_file)){
          $banner->pdf14      = Input::file('pdf14');
          if(!empty($pdf14_labelname))
            $banner->pdf14_name = Input::get('pdf14_name');
        }
