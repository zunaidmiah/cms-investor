...
Route::group(["before" => "auth"], function () {
  ...
  Route::get('admin/whistleblowerpolicy', 'CorporateController@WhistleBlowerPolicy');
  Route::get('admin/directorsfitandproperpolicy', 'CorporateController@DirectorsFitAndProperPolicy');
  Route::get('admin/genderdiversitypolicy', 'CorporateController@GenderDiversityPolicy');
  Route::get('admin/externalauditorsassessmentpolicy', 'CorporateController@ExternalAuditorsAssessmentPolicy');
  Route::get('admin/remunerationpolicy', 'CorporateController@RemunerationPolicy');
  Route::get('admin/cbce', 'CorporateController@Cbce');
  ...
  Route::get('admin/nominationcommittee', 'CorporateController@NominationCommittee');
  Route::get('admin/remunerationcommittee', 'CorporateController@RemunerationCommittee');
...
Route::resource('/sustainability/board-nomination-committe', 'SustainabilityController@front_tor_board_nomination');
...
Route::get('contacts/getsubcategory/{id}', 'ContactController@getSubcategory');
...
Route::resource('contactsubmit', 'ContactController@contactsubmit'); //addToFeedbackList
...
Route::resource('investorrelations/managementanalysis/whistleblowerpolicy', 'CorporateController@frontWhistleBlowerPolicy');
...
Route::resource('investorrelations/managementanalysis/genderdiversitypolicy', 'CorporateController@frontGenderDiversityPolicy');
Route::resource('investorrelations/managementanalysis/remunerationpolicy', 'CorporateController@frontRemunerationPolicy');
Route::resource('investorrelations/managementanalysis/externalauditorsassessmentpolicy', 'CorporateController@frontExternalAuditorsAssessmentPolicy');
Route::resource('investorrelations/managementanalysis/cbce', 'CorporateController@frontCbce');
...
Route::resource('investorrelations/financialinformation/remuneration_committee', 'CorporateController@BoardRemunationCommittee');
Route::resource('investorrelations/financialinformation/risk_management_committee', 'CorporateController@RiskManagementCommittee');
...
Route::get('investorrelations/frontadditionallisting', 'IpoController@frontAdditionallisting');
Route::get('investorrelations/frontadditionallistingdetail/{listing_id}', 'IpoController@frontAdditionallistingdetail');
//Route::get('investorrelations/frontadditionallistingsubdivision', 'IpoController@frontAdditionallistingsubdivision');
//Route::get('investorrelations/frontadditionallistingsubdivisiondetail/{listing_id}', 'IpoController@frontAdditionallistingsubdivisiondetail');
Route::get('investorrelations/auditcommittee', 'IpoController@auditcommittee');
...
Route::get('investorrelations/remunerationcommittee', 'IpoController@remunerationcommittee');
Route::get('investorrelations/remunerationcommitteedetail/{announce_id}', 'IpoController@remunerationcommitteedetail');
...
Route::get('investorrelations/interestshareholderlistsection138', 'IpoController@frontinterestshareholderlistsection138');
Route::get('investorrelations/interestshareholdersection138detail/{announce_id}', 'IpoController@frontinterestshareholdersection138detail');
Route::get('investorrelations/interestshareholderlistsection137', 'IpoController@frontinterestshareholderlistsection137');
Route::get('investorrelations/interestshareholdersection137detail/{announce_id}', 'IpoController@frontinterestshareholdersection137detail');
Route::get('investorrelations/personceasing', 'IpoController@frontpersonceasing');
...
Route::resource('investorrelations/managementanalysis/edividend', 'CorporateController@frontEdividend');
Route::resource('investorrelations/managementanalysis/summaryofshareholdersvotingrights', 'CorporateController@frontShareholdersvotingrights');
