                ...
                <div class="container">
                    <div class="row-fluid">
                        <div class="span12">
                             ...
                             <h5>No. 18, Jalan Jurunilai U1/20, Seksyen U1, HICOM Glenmarie Industrial Park, 40150 Shah Alam, Selangor, Malaysia</h5>
<ul class="unstyled">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <select class="input-xlarge" id="DDLCountry" name="DDLCountry">
                                      ...
                                      <option value="CÃ´te d`Ivoire">Côte d`Ivoire</option>
                                      ...
                                      <option value="SÃ£o TomÃ&copy; and PrÃ­ncipe">São Tomé and Príncipe</option>
