...
<script type="text/javascript" src="{{ URL::asset('js/modalPopup.js') }}"></script>
  ...
  <!--<div class="page-content">-->
          <div class="row">
            <div class="col-lg-12">
              <h2>eDividend<i class="fa fa-angle-right"></i> Listing</h2>
