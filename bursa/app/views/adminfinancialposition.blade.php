...
<script type="text/javascript" src="{{ URL::asset('js/modalPopup.js') }}"></script>
  ...
  <!--<div class="page-content">-->
          <div class="row">
            <div class="col-lg-12">
              <h2>Financial Position <i class="fa fa-angle-right"></i> Listing</h2>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          {{ Form::open(array('url' => 'admin/oursubsidiariesadd','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                              ...
                              {{Form::hidden('type','financialposition')}}
