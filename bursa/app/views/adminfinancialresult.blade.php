...
<div class="row">
  <div class="col-lg-12">
    ...
    <div class="portlet">
      <div class="portlet-header">
        <div class="caption">Financial Results Listing</div>
        <br />
              ...
              <div class="modal-body">
                <div class="form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      {{ Form::text('company_name','LIEN HOE CORPORATION BERHAD',array('id' => 'company','class' => 'form-control', 'placeholder' => 'company name' )) }}
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><a href="#" target="_blank">Please fill in content</a></td>
                            </tr>
                        ...
                        <table class="table table-striped">
                          ...
                          <thead>
                            <tr>
                              <td colspan="2"></td>
                              <td colspan="2">
                                <div align="center"><strong>Individual Period</strong></div>
                              </td>
                              <td colspan="2">
                                <div align="center"><strong>Cumulative Period</strong></div>
                              </td>
                            </tr>
                            <tr>
                              <td colspan="2"></td>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td colspan="2">Please fill in content</td>
                              <td colspan="2">Please fill in content</td>
                            </tr>
                        ...
                        <div class="row-fluid">
                          <div class="col-lg-12">
                            ...
                            <div class="alert alert-error">
                              ...
                              <div contenteditable="true" onblur="return div_val1(this.id)" id="announcement_reference">
                                <p>Please fill in reference no.</p>
                              </div>
                            </div>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="form">
                                ...
                                <div class="info_resalt border_bottom">
                                  <div class="row-fluid">
                                    <div class="col-lg-12">
                                      ...
                                      <div class="alert alert-error">
                                        <strong>Reference No:</strong>
                                        <div onblur="return div_val1(this.id)" id="announce_reference_no<?php echo $data->id; ?>" contenteditable="true">
                            ...
                            <textarea style="display: none;" name="reference_no" id="textarea_announce_reference_no{{$data->id}}">{{$data->reference_no}}</textarea>
