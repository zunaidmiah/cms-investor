...
@section('content')
  <div class="row">
            <div class="col-lg-12">
              <h2>Yee Lee Palm Oil Industries Sdn Bhd <i class="fa fa-angle-right"></i> Edit</h2>
...
<div class="grid_4 omega">
 ...
 {{Form::checkbox('active', 1 ,array('id'=>'active','class' => 'form-control'))}}
               ...
               {{ Form::hidden('type','pmmill',array('id' => 'type')) }}
                  ...
                  <table class="table table-hover table-striped">
                   ...
                   <tr>
                    ...
                    {{ Form::text('display_order$slidingbanner->id',$slidingbanner->display_order,array('id' => $slidingbanner->id,'class' => 'display_order form-control')) }}   
                        ...
                        <td><a title="" data-toggle="modal" data-target="#modal-edit-banner{{$slidingbanner->id}}" data-placement="top" data-hover="tooltip" href="#" data-original-title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a title="" data-toggle="modal" data-target="#modaldeletebanners{{$slidingbanner->id}}" data-placement="top" data-hover="tooltip" href="#" data-original-title="Delete"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
	 ...
	 {{ Form::close() }}
                 ...
                 @foreach( $processlistings  as $k => $processlisting )    
                      <tr>
                        ...
                        <td><a title="" data-toggle="modal" data-target="#modal-edit-processes{{ $processlisting->id }}" data-placement="top" data-hover="tooltip" href="#" data-original-title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> 
<a title="" data-toggle="modal" data-target="#modaldeleteprocess{{$processlisting->id}}" data-placement="top" data-hover="tooltip" href="#" data-original-title="Delete"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
