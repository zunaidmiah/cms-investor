...
<script type="text/javascript" src="{{ URL::asset('js/modalPopup.js') }}"></script>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2>Change of Registrar <i class="fa fa-angle-right"></i> Listing</h2>
            <div class="clearfix"></div>

            <div class="pull-left margin-top-10px"> Last updated: <span class="text-blue">{{ date("d F Y",strtotime($page[0]->updated_at)) }} @ {{ date("g:i A",strtotime($page[0]->updated_at)) }}</span>
            </div>
            <div class="pull-right"><a href="#" class="btn btn-red btn-lg">Update Announcement &nbsp;<i
            ...
            <div class="form-actions none-bg">
                <a href="javascript:void(0);" class="btn btn-red" onclick="Addsavepage('corporatdirprofile','');">Save
                    &amp; Preview &nbsp;<i class="fa fa-search"></i></a>&nbsp;
            ...
            <div class="portlet">
                <div class="portlet-header">
                    <div class="caption">Change of Registrar Announcements Listing</div>
                    <br/>
                    <p class="margin-top-10px"></p>
                    <a href="#" data-target="#modal-add-announcement" data-toggle="modal" class="btn btn-success">Add
                        New Announcement &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                    <div class="btn-group">
                        ...
                        <li><a href="#" onclick="MyFunction();return false;">Delete selected item(s)</a></li>
                            <!-- <li><a href="#" data-target="#modal-delete-selected" data-toggle="modal">Delete selected
                                    item(s)</a></li> -->
                            <li class="divider"></li>
                    ...
                    <div id="modal-add-announcement" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Announcement Date <span
                                                        class='require'>*</span></label>
                                            <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <p class="text-blue margin-top-10px border-bottom">You can add content
                                                    by clicking the text below.</p>
                                                <div onblur="return div_val1(this.id)" id="announcement_content"
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="alert alert-error">
                                                                ...
                                                                <div contenteditable="true"
                                                                     onblur="return div_val1(this.id)"
                                                                     id="announcement_reference"><p>Please fill in
                                                                        reference no.</p></div>
                                                            </div>
                    ...
                    <div id="modal-delete-selected-process" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
                         aria-hidden="true" class="modal fade">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <td><?php echo $i; ?></td>
                            <td><?php  if($data->status == 1){ ?><span
                                        class="label label-sm label-success">Active</span><?php }else{ ?><span
                                        class="label label-sm  btn-primary">Inactive</span> <?php } ?></td>
                            <td><?php echo $data->date_of_publishing;?></td>
                            <td><?php echo $data->company_name;?></td>
                            <td><?php echo $data->title;?></td>
                            <td><a href="#" data-hover="tooltip" data-placement="top"
                                   data-target="#modal-edit-announcement<?php echo $data->id;?>" data-toggle="modal"
                                   title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>
                                <a href="#" data-hover="tooltip" data-placement="top" title="Delete"
                                   data-target="#modal-delete-<?php echo $data->id;?>" data-toggle="modal"><span
                                            class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                <!--Modal edit announcement start-->
                                <div id="modal-edit-announcement<?php echo $data->id;?>" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-body">
                                                <div class="form">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div data-on="success" data-off="primary"
                                                                ...
                                                                if ($data->status)
                                                                    ...
                                                                    $opt['checked'] = '';
                                                                ?>
                                                                <input <?php if($data->status == 1) {?>checked
                                                                       <?php }?>name="status" type="checkbox" value="1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="text-blue margin-top-10px border-bottom">You can
                                                                add content by clicking the text below.</p>
                                                            <div onblur="return div_val1(this.id)"
                                                                 id="announcement_content<?php echo $data->id;?>"
                                                                 contenteditable="true">
                                                                {{$data->html}}
                                                            </div>
                                                            <textarea style="display: none;" name="html"
                                                                      id="textarea_announcement_content{{$data->id}}">{{$data->html}}</textarea>
                                                            <!-- Info Resalt-->
                                                            <div class="info_resalt border_bottom">
                                                                <div class="row-fluid">
                                                                    <div class="col-lg-12">
                                                                        <div>
                                                                            <h2 class="red-title"><span>Announcement Info</span>
                                                                            </h2>
                                                                        </div>
                                                                        <div class="alert alert-error">
                                                                            <strong>Reference No:</strong>
                                                                            <div onblur="return div_val1(this.id)"
                                                                                 id="announce_reference_no<?php echo $data->id; ?>"
                                                                                 contenteditable="true">
                                                                                <p><?php echo $data->reference_no;?></p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <input type="hidden" name="reference_no"
                                                           ...
                                                           id="textarea_announce_reference_no<?php echo $data->id;?>">
                                ...
                                <!--Modal delete start-->
                                <div id="modal-delete-{{$data->id}}" tabindex="-1" role="dialog"
                                     aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 id="modal-login-label3" class="modal-title"><a href=""><i
                                                    ...
                                                    you want to delete this announcement? </h4>
                                            </div>
                                            <div class="modal-body">
                    ...
                    <div class="tool-footer text-right">
                        <p class="pull-left">Showing {{ $accountlisting->getFrom() }} to {{ $accountlisting->getTo() }}
                            of {{ $accountlisting->getTotal() }} entries</p>
