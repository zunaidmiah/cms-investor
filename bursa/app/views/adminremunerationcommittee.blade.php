...
//-->
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2>Changes in Remuneration Committee <i class="fa fa-angle-right"></i> Listing</h2>
			 ...
			 {{ Form::close()}} 
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Changes in Remuneration Committee Listing</div>
                  <br/>
                        ...
                        <div class="modal-body">
                          ...
                          {{ Form::open(array('url' => 'admin/newscenter/saveannouncements','class'=> 'form-horizontal','method' => 'post','files' => true, 'onsubmit' => 'fillRefernce();')) }}
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6">
								{{ Form::text('company_name','LIEN HOE CORPORATION BHD',array('id' => 'company','class' => 'form-control', 'placeholder' => 'company name' )) }} 
