...
@section('content')
			...
			<header class="entry-header clearfix">
				...
				<div class="entry-header-inner">
				  ...
				  <div class="grid_6">
							...
							<!-- Contact Form -->
							<div class="box">
         {{ Form::open(array('url' => 'contacts/feedback/submitfeedback', 'id' => 'feedback-form', 'method' => 'post', 'class' => 'contact-form input-blocks')) }}      				
									<div class="field">
	<label for="name"><strong>Your Name</strong> <span class="text-red">(*required)</span></label>
	...
	{{ Form::text('company_name','',array('id' => 'company_name','class' => 'validate[required]'))}}
        	...
        	{{ Form::textarea('company_address','',array('id' => 'company_address','class' => 'validate[required]','cols' => '30','rows' => '10'))}}
									</div>
                                    <div class="field">
	...
	{{ Form::text('state','',array('id' => 'state'))}}
                                    ...
                                    <div class="field">
										<label for="name"><strong>Post Code</strong> </label>
...
<option value="Zimbabwe">Zimbabwe</option>
					...
					{{ Form::text('email','',array('id' => 'email','class' => 'validate[required,custom[email]]'))}}
									...
									<div class="field">
										<label for="email"><strong>Contact Number</strong> <span class="text-red">(*required)</span></label>
						{{ Form::text('contact_number','',array('id' => 'contact_number','class' => 'validate[required]'))}}
									</div>
                                    <div class="field">
										<label for="subject"><strong>Subject</strong> <span class="text-red">(*required)</span></label>
						{{ Form::text('subject','',array('id' => 'subject','class' => 'validate[required]'))}}
									</div>
									<div class="field">
										<label for="contact-message"><strong>Questions &amp; Comments</strong> <span class="text-red">(*required)</span></label>
