                  ...
                  <table class="table table-striped">
                    ...
                    @if( isset($announcements) && count($announcements) > 0 )
                        ...
                        @foreach( $announcements as $announcement )
                            <tr>
                                ...
                                <td><a href="/investorrelations/frontfinanciallistingdetail/{{$announcement->id}}">{{ $announcement->title }}</a></td>
                            </tr>
                        @endforeach
                    @else
                        <tr>
                    ...
                    @endif
                      {{--<tr>--}}
                         ...
                         {{--<td><a href="news_centre_bursa_financial_results_details_20150226.html">Quarterly rpt on consolidated results for the financial period ended 31/12/2014</a></td>--}}
                      {{--</tr>--}}
                     </tbody>
                    <tfoot>
                    	<tr>
