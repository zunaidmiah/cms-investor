...
<div class="row">
    <!--<div class="container">-->
    <h2 class="red-title pull-left"><span>{{ $page[0]->left_block1_title }}</span></h2>
    ...
    <div class="row-fluid">
        ...
        <div class="span2 pull-left">
            ...
            <div class="alert {{ $sclass }}">
                <strong id="price">{{ number_format($stockdata->close,3) }}</strong>
            </div>
        </div>
        ...
        <div class="span2 pull-left">
            ...
            ?>
            <div class="alert {{ $sclass }}">
                <i class="{{ $iclass }}"></i> <strong id="change">{{ number_format($stockdata->adj,3) }}</strong>
            </div>
        </div>
        ...
        <div class="span2 pull-left">
            ...
            <div class="alert {{ $sclass }}">
                <i class="{{ $iclass }}"></i> <strong id="percent">{{ number_format($stockdata->percentage_change,3) }}%</strong>
            </div>
        </div>
