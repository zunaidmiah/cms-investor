                ...
                <div class="col-md-12">
                	<div id="twitter-bootstrap-container">
                        <div id="twitter-bootstrap-tabs">
                             ...
                             @if($k == 0)
                             {{ Form::open(array('url' => '/investorrelations/managementanalysis/summaryofshareholdersvotingrights','method' => 'post','name' => 'summaryofshareholdersvotingrights', 'id' => 'summaryofshareholdersvotingrights' )) }}       
