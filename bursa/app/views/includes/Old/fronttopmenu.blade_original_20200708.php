 <!-- Nav-->
                        <nav class="span9">
                            ...
                            <ul id="menu" class="sf-menu">
                                ...
                                <li>
                                	<a href="#">COMPANY</a>
                                	<ul>                                  										<li><a href="http://cms.fareastholdingsbhd.com/profile">Corporate Profile</a></li>										<li><a href="http://cms.fareastholdingsbhd.com/structure">Corporate Structure</a></li>
                                ...
                                <li><a href="#">SUSTAINABILITY</a>
                                        	<ul>
                                                ...
                                                {{-- <li><a href="">Certification</a>
                                                	<ul>														<li><a href="{{url('/')}}/frontend/img/certificates/SGS_Certificate.pdf">SGS Certificate</a></li>
                                                    	<!--<li><a href="http://bursa.fareastholdingsbhd.com/frontend/img/certificates/SGS_Certificate.pdf">SGS Certificate</a></li>-->
                                        ...
                                        <li><a href="#">GOVERNANCE</a>
                                        	<ul>												 <li><a href="{{url('/')}}/investorrelations/corporategovernance">Corporate Governance</a></li>
                                                ...
                                                <li><a href="{{url('/')}}/sustainability/board-nomination-committe">Terms of Reference - Board Nomination Committee</a></li>
                                                <li><a href="{{url('/')}}/sustainability/tor-risk-management-committee">Terms of Reference - Risk Management Committee</a></li>
                                                <li><a href="{{url('/')}}/sustainability/tor-audit-management-committee">Terms of Reference - Audit Management Committee</a></li>
