                                	...
                                	<ul>
                                    	<li><a href="#">Policies</a>
                                        	<ul>
                                                ...
                                                <li><a href="{{url('/')}}/sustainability/Environmental-protection-biological-diversity-policy">Environmental Protection &amp; Biological Diversity Policy</a></li>
                                                ...
                                                {{-- <li><a href="">Certification</a>
                                                	<ul>														<li><a href="{{url('/')}}/frontend/img/certificates/SGS_Certificate.pdf">SGS Certificate</a></li>
                                                        <li><a href="http://bursa.fareastholdingsbhd.com/frontend/img/certificates/Burueau_Veritas_Certification.pdf">Bureau Veritas Certification</a></li>
                                                    </ul>
                                                </li> --}}
                                        ...
                                        <li><a href="#">GOVERNANCE</a>
                                        	<ul>												 
                                                ...
                                                <li><a href="{{url('/')}}/investorrelations/managementanalysis/reviewoperations">Board Charter</a></li>
                                                <li><a href="#">Policies</a>
                                        			<ul>
                                                        <li><a href="{{url('/')}}/investorrelations/managementanalysis/chairmanstatement">Whistle Blower Policy</a></li>
                                                        <li><a href="{{url('/')}}/investorrelations/financialinformation/equitychanges">Anti-Bribery &amp; Anti-Corruption Policy</a></li>
                                                    </ul>
                                                </li>
                                               
                                                <li><a href="#">Terms of Reference</a>
                                        			<ul>	
                                                        <li><a href="{{url('/')}}/sustainability/board-nomination-committe">Nomination Committee</a></li>
                                                        <li><a href="{{url('/')}}/sustainability/tor-risk-management-committee">Risk Management Committee</a></li>
                                                        <li><a href="{{url('/')}}/sustainability/tor-audit-management-committee">Audit Committee</a></li>
                                                        <li><a href="{{url('/')}}/investorrelations/corporateinformation/oursubsidiaries">Remuneration Committee</a></li>
                                                    </ul>
                                                </li>
                                    ...
                                    <ul>                             
                                        ...
                                        <li><a href="#">Board Committees</a>
                                        	<ul>
                                                ...
                                                <li><a href="{{url('/')}}/investorrelations/financialinformation/cashflowstatement">Nomination Committee</a></li>
                                                <li><a href="http://www.fareastholdingsbhd.com/frontend_html/board_committees_risk_management_committee.html">Risk Management Committee</a></li>
                                          		<li><a href="{{url('/')}}/investorrelations/corporateinformation/ourproperties">Audit Committee</a></li>
                                        ...
                                        <!--<li><a href="http://bursa.fareastholdingsbhd.com/investorrelations/eventcalendar">Events Listing</a></li>-->
                                    </ul>
                                </li> 
