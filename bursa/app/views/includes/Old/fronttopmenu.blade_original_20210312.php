...
<ul class="sub-menu">
    <li class="menu-item"><a href="{{ URL::to('/cms/profile') }}">Corporate Profile</a>
    <ul class="sub-menu">
              <li class="menu-item"><a href="{{ URL::to('cms/ceomessage') }}">CEO Message</a></li>
                                                   </ul>
    </li>
...
<li class="menu-item menu-item-has-children arrow"><a href="#">Core Business</a>
    <ul class="sub-menu">
        <li class="menu-item"><a href="{{ URL::to('/cms/core_sub/core_pdib') }}">Property Development &amp; Infrastructure</a></li>
        <li class="menu-item"><a href="{{ URL::to('/cms/core_sub/core_sb') }}">Strategic Business</a></li>
        <li class="menu-item"><a href="{{ URL::to('/cms/core_sub/core_lafmb') }}">Land, Asset &amp; Facility Management</a></li>
    </ul>
</li>
...
<li class="menu-item"><a href="#">Policies</a>
                <ul class="sub-menu">
                                <li class="menu-item"><a href="{{ URL::to('investorrelations/managementanalysis/sustainabilitypolicy') }}">Sustainability Policy</a></li>
                                <li class="menu-item"><a href="{{ URL::to('investorrelations/managementanalysis/whistleblowerpolicy') }}">Whistle Blower Policy</a></li>
                ...
                <ul class="sub-menu">
                                ...
                                <li class="menu-item"><a href="{{ URL::to('sustainability/tor-risk-management-committee') }}">Risk Management Committee</a></li>
