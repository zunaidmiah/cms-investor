...
@include('includes.fronthead')
  ...
  <body> 
        ...
        .banner_subpage5 {
                ...
                background-image: url(http://cms.lienhoecorporationbhd.com/uploads/banners/{{$banner}});
                    ...
                    @foreach ($breadcrumbs as $k => $breadcrumb)
                        <li>
                            @if($breadcrumb['url'] != '' || $k == 0 || $k == 1)
                                @if($k == 0)
                                    <?php $url = "http://cms.lienhoecorporationbhd.com" ?>
                                @elseif($k == 1)
                                   <?php $url = "http://bursa.lienhoecorporationbhd.com" ?>
                                @else
