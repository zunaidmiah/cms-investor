...
<div class="info_white1 border_bottom">
            <div class="container">
              <h2 class="red-title pull-left">Changes in Nomination Committee</h2>
                  ...
                  <table class="table table-striped">
                    ...
                    @if( isset($announcements) && count($announcements) > 0 )
                        ...
                        @foreach( $announcements as $announcement )
                            <tr>
                                ...
                                <td><a href="/investorrelations/nominationcommitteedetail/{{ $announcement->id }}">{{ $announcement->title }}</a></td>
                            </tr>
                        @endforeach
                    @else
                        <tr>
                    ...
                    @endif
                      {{--<tr>--}}
                         ...
                         {{--<td><a href="news_centre_bursa_changes_in_nomination_committee_details.html">Changes in Nomination Committee</a></td>--}}
                      {{--</tr>--}}
                      <!--<tr>
                         <td>2</td>
                         <td>04 Jan 2013</td>
