                  ...
                  <table class="table table-striped">
                    ...
                    @if( isset($announcements) && count($announcements) > 0 )
                        ...
                        @foreach( $announcements as $announcement )
                            <tr>
                                ...
                                <td><a href="/investorrelations/principalofficerdetail/{{ $announcement->id }}">{{ $announcement->title }}</a></td>
                            </tr>
                        @endforeach
                    @else
                        <tr>
                    ...
                    @endif
                      {{--<tr>--}}
                         ...
                         {{--<td><a href="news_centre_bursa_change_in_principal_officer_details_20150105.html">Change in Principal Officer</a></td>--}}
                      {{--</tr>--}}
                      {{--<tr>--}}
                         {{--<td>2</td>--}}
                         {{--<td>15 Oct 2014</td>--}}
                         {{--<td>FAR EAST HOLDINGS BERHAD</td>--}}
                         {{--<td><a href="news_centre_bursa_change_in_principal_officer_details_20141015.html">Change in Principal Officer</a></td>--}}
                      {{--</tr>--}}
                      {{--<tr>--}}
                         {{--<td>3</td>--}}
                         {{--<td>29 Aug 2014</td>--}}
                         {{--<td>FAR EAST HOLDINGS BERHAD</td>--}}
                         {{--<td><a href="news_centre_bursa_change_in_principal_officer_details.html">Change in Principal Officer</a></td>--}}
                      {{--</tr>--}}
                      <!--<tr>
                         <td>2</td>
                         <td>28 Feb 2013</td>
                         <td>FAR EAST HOLDINGS BERHAD</td>
                         <td><a href="#">Change in Principal Officer</a></td>
                      </tr>
                      <tr>
                         <td>3</td>
                         <td>28 Feb 2013</td>
