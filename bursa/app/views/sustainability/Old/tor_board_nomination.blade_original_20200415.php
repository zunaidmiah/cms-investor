  ...
  <!--<div class="page-content">-->
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <h2>Terms of Reference - Board Nomination Committee <i class="fa fa-angle-right"></i> Listing</h2>
...
<div class="form-actions none-bg"> 
	...
	<a href="javascript:void(0);" class="btn btn-red" onclick="Addsavepage('corporatdirprofile','');">Save &amp; Preview &nbsp;<i class="fa fa-search"></i></a>&nbsp; <button type="submit" class="btn btn-blue">Save &amp; Publish &nbsp;<i class="fa fa-globe"></i></button>&nbsp; <a href="#" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
              ...
              <div id="myTabContent" class="tab-content">
                ...
                <div class="portlet-header">
                  ...
                  <div class="btn-group">
                    ...
                    <!-- <li><a href="#" data-target="#modal-delete-selected-process" data-toggle="modal" class="deleteid" rel=" 
                      {{url();}}/admin/page/pdfdeletemultiple" rev="modal-delete-selected-process">Delete selected item(s)</a></li> -->
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          {{ Form::open(array('url' => 'admin/oursubsidiariesadd','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                              ...
                              {{Form::hidden('type','tor_board_nomination')}}
					 ...
					 @foreach ($profilelist as $k => $slidingbanner)   
                      ...
                      <tr>
                        ...
                        <td>
                        	...
                        	<a href="#" data-hover="tooltip" data-placement="top" data-target="#modal-edit-director{{$slidingbanner->id}}" data-toggle="modal" title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> 



                        	<a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-dir{{$slidingbanner->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                              ...
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-header">
                                    ...
                                    <h4 id="modal-login-label3" class="modal-title"><a href=""><i class="fa fa-exclamation-triangle"></i></a> Are you sure you want to delete this? </h4>
