		...
		return View::make('frontcorporategovernance',array(
		 ...
		 public function frontManagementChairmansStat() {
                ...
                if (Input::has('datesort'))
                {
                    ...
                    if($dateSort == 'latest')
                    {
                        $pdfs = Pdf::where('type','=','managementanalysischairmain')->where('active','=',1)->orderBy('updated_at','DESC')->get();
                    }
                    else
                    {
                        $pdfs = Pdf::where('type','=','managementanalysischairmain')->where('active','=',1)->where('date','=',$dateSort)->orderBy('updated_at','DESC')->get();
                    }
                }
               ...
               $profieDate = Pdf::select('date')->where('type','=','managementanalysischairmain')->where('active','=',1)->orderBy('updated_at','DESC')->distinct()->get();
