...
class AddBannerimageFieldsToManufacturingProcesseslistingsTable extends Migration {
	...
	public function up()
	{	
		Schema::table('manufacturing_processeslistings', function(Blueprint $table) {		
