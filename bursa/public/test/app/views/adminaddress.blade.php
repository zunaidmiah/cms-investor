...
@section('content')
      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2>Change of Address <i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Change of Address Announcements Listing</div>
                  <br/>
                  ...
                  <div id="modal-delete-selected" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p><strong>#1:</strong> 08 Sept, 2014 - Change of Address</p>
                          <div class="form-actions">
                                      ...
                                      <div class="form">
                                        <form class="form-horizontal">
                                          ...
                                          <div class="form-group">
                                            <label class="col-md-3 control-label">Title <span class='require'>*</span></label>
                                            <div class="col-md-6">
                                              <textarea name="inputContent" rows="2" class="form-control" id="inputContent">Change of Address</textarea>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-md-3 control-label">Announcement Date <span class='require'>*</span></label>
                                            <div class="col-md-5">
                                              <div class="input-group">
                                                <input type="text" class="datepicker-default form-control" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy" value="08 Sept, 2014"/>
                                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                              </div>
                                            </div>
                                          </div>
