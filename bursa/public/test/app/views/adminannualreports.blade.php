                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 id="modal-login-label2" class="modal-title">Add Annual Report</h4>
                        </div>
                        <div class="modal-body">
                          ...
                          {{ Form::open(array('url' => 'admin/add','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                              ...
                              {{Form::hidden('type','annualreports')}}
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  {{ Form::open(array('url' => 'admin/edit','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                                        ...
                                        <div class="form-group">
                                          <label class="col-md-4 control-label">Title <span class='require'>*</span></label>
                                          <div class="col-md-8"> {{ Form::textarea('title',$slidingbanner->title, array('id' => 'title','class' => 'form-control', 'rows' => '2')) }}
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <label class="col-md-4 control-label">Date <span class='require'>*</span></label>
...
{{ Form::file('image',array('id' => 'image')) }}        
										...
										<div class="form-group">
                                          ...
                                          <div class="col-md-8">
                                               <a href="{{$slidingbanner->pdf->url()}}" target="_blank">{{$slidingbanner->pdf_file_name}}</a>
                            ...
                            <div id="modal-delete-dir{{$slidingbanner->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                    <h4 id="modal-login-label3" class="modal-title"><a href=""><i class="fa fa-exclamation-triangle"></i></a> Are you sure you want to delete this annual report? </h4>
                                  </div>
                                  <div class="modal-body">
