...
@section('content')
      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2>Trading of Rights Announcement <i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Trading of Rights Announcements Listing</div>
                  <br/>
                                ...
                                <div class="col-md-9"> 
                                   ...
                                   <div class="table-responsive">
                                                   <div contenteditable="true">
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                             <td><strong>Please fill in content</strong></td>
                  ...
                  <div id="modal-delete-selected" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p><strong>#1:</strong> 29 June, 2012 - Announcement Title</p>
                          <div class="form-actions">
