...
@section('content')
      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2>Investor Alert <i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Investor Alert Announcements Listing</div>
                  <br/>
                  ...
                  <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu">
                      <li><a href="#" rel="{{url();}}/admin/page/investoralertsdeletemultiple" data-target="#modal-delete-selected" data-toggle="modal" class="deleteid"  rev="modal-delete-selected">Delete selected item(s)</a></li>
                      <li class="divider"></li>
                  ...
                  <div id="modal-add-announcement" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog modal-wide-width">
					  ...
					  {{ Form::open(array('url' => 'admin/inverstoralert/saveinverstor','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
 ...
 <textarea name="textarea_reference" id="textarea_reference" style="display:none;"></textarea>
                              ...
                              {{Form::hidden('type','Investor Alert')}}
