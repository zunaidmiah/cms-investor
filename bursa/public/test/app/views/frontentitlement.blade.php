...
<form method="POST" id="year_form">
 ...
 <div class="info_white1 border_bottom">
            <div class="container">
              <h2 class="red-title pull-left"><span>Entitlement Summary</span></h2>
        ...
        <form method="POST">
          ...
          if((!empty($frontEntitlement)) && (count($frontEntitlement)!=0)){
          foreach($frontEntitlement as $Entitlement){
          ?>
          <tr>
                        <td><?php echo $i;?></td>
                        <td><?php echo $Entitlement->date_of_publishing;?></td>
                        <td><?php echo $Entitlement->company_name;?></td>
                        <th><?php echo $Entitlement->title;?></th>
                        <td> </td>
                        <td></td>
                        <td></td>
                      </tr>
