...
@section('content')
      ...
      <h2 class="red-title pull-left">News Alert Unsubscription</h2>
			  ...
			  <div class="row-fluid">
                <div class="span12">
                <p>Thank you for using <strong>OCK GROUP BERHAD</strong>'s News Alert. If you wish to unsubscribe the email alerts, please provide us your email address as below.</p>
                   {{ Session::get('message') }}
