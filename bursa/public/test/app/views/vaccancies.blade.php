...
@section('content')
           <div class="row">
            <div class="col-lg-12">
              ...
              <div class="clearfix"></div>
              <p></p>
              {{ Form::open(array('url' => 'admin/page/savepage','name' => 'savepage','id' => 'savepage','class'=> 'form-horizontal','method' => 'post')) }}
               {{Form::hidden('preview','')}}
                ...
                <div class="portlet-header">
                  ...
                  <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu">
                      <li><a href="#" data-target="#modal-delete-selected" data-toggle="modal" class="deleteid" rel="{{url();}}/admin/page/deletemultiplevaccancies" rev="modal-delete-selected">Delete selected item(s)</a></li>
                      <li class="divider"></li>
 ...
 {{Form::checkbox('active', 1,1,array('id'=>'active','class' => 'form-control'))}}                                 
             ...
             {{Form::textarea('job_title','',array('id'=>'job_title','class' => 'validate[required] form-control','rows' => '2'))}}     
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
             {{Form::textarea('company','',array('id'=>'company','class' => 'validate[required] form-control','rows' => '2'))}}                                     </div>
                              </div>
                              <div class="form-group">
  ...
  {{ Form::open(array('url' => 'admin/vaccancy/editvaccancy', 'name' => "editvaccancy$vaccancy->id", 'id' => "editvaccancy$vaccancy->id" , 'method' => 'post', 'class' => 'form-horizontal','files' => true)) }} 
                                          ...
                                          <div class="col-md-9">
                                            <div data-on="success" data-off="primary" class="make-switch" >
   {{ Form::checkbox('active',$vaccancy->active,$vaccancy->active,array('id' => 'active','class' => 'check-switch')) }}
                                            </div>
                                          </div>
                                        </div>
                                        <div class="form-group">
  ...
  {{ Form::text('post_date',$vaccancy->post_date ,array('id' => 'post_date','data-date-format' => 'dd/mm/yyyy','placeholder' => 'dd/mm/yyyy','class' => 'datepicker-default form-control' ,'rows' => '2')) }}
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-9"> 
                                            ...
                                            {{ Form::textarea('requirements_content',$vaccancy->requirements_content,array("id" => "textarea-vacc-req$vaccancy->id","class" => "hideThisField")) }}
                                        </div>
                                        <div class="form-group">
                                          <label for="inputContent" class="col-md-3 control-label">Footer Content</label>
                                          <div class="col-md-9">
