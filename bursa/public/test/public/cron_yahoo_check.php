...
$source = mysql_connect('localhost', 'ocknetmy_bursa', 'OcknetDb@123') or die("Can't connect user 'ocknetmy_bursa' from source DB. MySQL Says:".  mysql_error());
$dest = mysql_connect('localhost', 'ocknetmy_bursa', 'OcknetDb@123',true) or die("Can't connect user 'ocknetmy_bursa' from source DB. MySQL Says:".  mysql_error());

mysql_select_db('ocknetmy_yahoo', $source) or die("Can't Select source DB. MySQL Says:".  mysql_error());
mysql_select_db('ocknetmy_bursa', $dest) or die("Can't Select dest., DB. MySQL Says:".  mysql_error());
