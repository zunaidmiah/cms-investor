                                                        ...
                                                        <table width="100%" cellpadding="8">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #b8312f;text-decoration: none;outline: none;" href="mailto:davidlow@myock.com">davidlow@myock.com</a>; <a style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #b8312f;text-decoration: none;outline: none;" href="mailto:wongsy@myock.com">wongsy@myock.com</a></td>
                                                                </tr>
                                                                <tr bgcolor="#f5f5f5">
                                                                ...
                                                                <tr bgcolor="#f5f5f5">
                                                                    ...
                                                                    <td><span style="font-family: 'Open Sans', sans-serif; font-size: 16px; color:#777;"><strong>Media News:</strong> OCK To More Than Double Indonesian Operation (Pending for Approval)</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="140"><span style="font-family: 'Open Sans', sans-serif; font-size: 16px; color:#777;">Date</span></td>
                                                                    <td><span style="font-family: 'Open Sans', sans-serif; font-size: 16px; color:#777;">15 Sept, 2014</span></td>
                                                                </tr>
                                                                <tr bgcolor="#f5f5f5">
                                                                    <td width="140"><span style="font-family: 'Open Sans', sans-serif; font-size: 16px; color:#777;">Source / URL</span></td>
                                                                    <td><span style="font-family: 'Open Sans', sans-serif; font-size: 16px; color:#777;">The Edge</span><br/> <a style="font-family: 'Open Sans', sans-serif; size: 16px; color: #b8312f;text-decoration: none;outline: none;" href="http://www.thestar.com.my" target="_blank">http://www.thestar.com.my</a></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                    ...
                                                    <div style="background: #FFFFFF; padding: 15px; border-bottom-left-radius: 5px; border-bottom-right-radius: 5px;">
                                                        <table width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <h2 style="color: #cc0000; font-size:28px; line-height: 36px; font-family: Arial, Helvetica, sans-serif; ">OCK To More Than Double Indonesian Operation</h2>
                                                                        <h5 style="font-size:18px; line-height: 28px; font-family:Arial, Helvetica, sans-serif; color: #403e3d;">To increase telecommunication sites to 20,000 within two years</h5>
                                                                        <blockquote style="padding: 10px 20px; margin: 0 0 20px; font-size: 17.5px; border-left: 5px solid #eee">
                                                                            <footer><cite title="Source Title"><span style="font-size: 15px; color:#999; font-style: normal; font-family: 'Open Sans', sans-serif;">The Edge</span></cite></footer>
                                                                        </blockquote>
                                                                        ...
                                                                        <p style="margin:0 0 20px 0; padding: 0; font-weight: 300; font-family: 'Open Sans', sans-serif; font-size: 16px;">News content body here.</p>
                                                                        <div style="clear:both"></div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
