...
<link rel='stylesheet' href='frontend/assets/new/css/core/reset.css' type='text/css' media='all'>
    ...
    <link rel='stylesheet' href='frontend/assets/new/css/elementor/pagebuilder3141.css' type='text/css' media='all'>
    <link rel='stylesheet' href='frontend/assets/new/css/elementor/pagebuilder5733.css' type='text/css' media='all'>
    <link rel='stylesheet' href='frontend/assets/new/css/elementor/pagebuilder4903.css' type='text/css' media='all'>
    <link rel='stylesheet' href='frontend/assets/new/css/elementor/pagebuilder3274.css' type='text/css' media='all'>
    <link rel='stylesheet' href='frontend/assets/new/css/elementor/bootstrap.min.css' type='text/css' media='all'>



<link rel="apple-touch-icon" sizes="57x57" href="frontend/assets/new/images/apple-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="frontend/assets/new/images/apple-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="frontend/assets/new/images/apple-icon-72x72.png">
<link rel="apple-touch-icon" sizes="76x76" href="frontend/assets/new/images/apple-icon-76x76.png">
<link rel="apple-touch-icon" sizes="114x114" href="frontend/assets/new/images/assets/new/images/apple-icon-114x114.png">
<link rel="apple-touch-icon" sizes="120x120" href="frontend/assets/new/images/apple-icon-120x120.png">
<link rel="apple-touch-icon" sizes="144x144" href="frontend/assets/new/images/apple-icon-144x144.png">
<link rel="apple-touch-icon" sizes="152x152" href="frontend/assets/new/images/apple-icon-152x152.png">
<link rel="apple-touch-icon" sizes="180x180" href="frontend/assets/new/images/apple-icon-180x180.png">
<link rel="icon" type="image/png" sizes="192x192"  href="frontend/assets/new/images/android-icon-192x192.png">
<link rel="icon" type="image/png" sizes="32x32" href="frontend/assets/new/images/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="96x96" href="frontend/assets/new/images/favicon-96x96.png">
<link rel="icon" type="image/png" sizes="16x16" href="frontend/assets/new/images/favicon-16x16.png">
<link rel="manifest" href="frontend/assets/new/images/manifest.json">
<meta name="msapplication-TileColor" content="#ffffff">
<meta name="msapplication-TileImage" content="frontend/assets/new/images/ms-icon-144x144.png">
            ...
            <div class="mobile-menu-content">
				...
				<li class="menu-item"><a href="<?php echo 'cms/profile'; ?>">Corporate Profile</a></li>
						...
						<li class="menu-item menu-item-has-children"><a href="#">Core Business</a>
                            <ul class="sub-menu">
                                <li class="menu-item"><a href="<?php echo 'cms/core_sub/core_pdib'; ?>">Building & Civil Works</a></li>
                                <li class="menu-item"><a href="<?php echo 'cms/core_sub/core_sb'; ?>">Hospitality</a></li>
                                <li class="menu-item"><a href="<?php echo 'cms/core_sub/core_lafmb'; ?>">Property Development & Investment</a></li>
                            </ul>
                        </li>
                        	...
                        	<ul class="sub-menu">
							    ...
							    <li class="menu-item"><a href="#">Policies</a>
									<ul class="sub-menu">
										...
										<li class="menu-item"><a href="<?php echo 'bursa/investorrelations/managementanalysis/directorsfitandproperpolicy'; ?>">Directors’ Fit and Proper Policy</a></li>
										<li class="menu-item"><a href="<?php echo 'bursa/investorrelations/managementanalysis/externalauditorsassessmentpolicy'; ?>">External Auditors Assessment Policy</a></li>
										<li class="menu-item"><a href="<?php echo 'bursa/investorrelations/managementanalysis/genderdiversitypolicy'; ?>">Gender Diversity Policy</a></li>
										<li class="menu-item"><a href="<?php echo 'bursa/investorrelations/managementanalysis/remunerationpolicy'; ?>">Remuneration Policy</a></li>
                            			<li class="menu-item"><a href="<?php echo 'bursa/investorrelations/managementanalysis/whistleblowerpolicy'; ?>">Whistleblowing Policy</a></li>
                                    </ul>
								 </li>
                            	 <li class="menu-item"><a href="#">Terms of Reference</a>
									 <ul class="sub-menu">
                            		 	...
                            		 	<li class="menu-item"><a href="<?php echo 'bursa/sustainability/tor-risk-management-committee'; ?>">Audit & Risk Management Committee</a></li>
                       ...
                       <li class="megamenu col4 menu-item menu-item-has-children"><a href="<?php echo 'bursa/'; ?>">Investor Relations</a>
                        <ul class="sub-menu">
                            ...
                            <li class="menu-item menu-item-has-children"><a href="#">Share Information</a>
                                <ul class="sub-menu">
                                    <li class="menu-item"><a href="<?php echo 'bursa/investorrelations/shareinformation/priceticker'; ?>">Stock Quote</a></li>
			    			...
			    			<li class="menu-item menu-item-has-children"><a href="#">News Centre</a>
                                <ul class="sub-menu">
									...
									<li class="menu-item"><a href="<?php echo 'medianews/media'; ?>">Media News</a></li>
							...
							<li class="menu-item"><a href="<?php echo 'bursa/investorrelations/managementanalysis/summaryofshareholdersvotingrights'; ?>">Summary of Shareholders' Voting Rights</a></li>
							<li class="menu-item"><a href="<?php echo 'bursa/investorrelations/managementanalysis/edividend'; ?>">eDividend</a></li>
                                                ...
                                                <div class="elementor-element elementor-element-01f3d0b elementor-icon-list--layout-inline elementor-mobile-align-center elementor-tablet-align-center elementor-widget elementor-widget-icon-list"  data-element_type="widget"  data-widget_type="icon-list.default">
                                                    <div class="elementor-widget-container">
                                                        <ul class="elementor-icon-list-items elementor-inline-items">
                                                            ...
                                                            <li class="elementor-icon-list-item">
                                                            <a href="mailto:info@lienhoecorporationbhd.com"><span class="elementor-icon-list-icon">
                                                            <i aria-hidden="true" class="far fa-envelope"></i></span>
                                                            <span class="elementor-icon-list-text">info@lienhoecorporationbhd.com</span>
                                                            </a>
                                                            </li>
                                                ...
                                                <div class="elementor-element elementor-element-419171e elementor-widget elementor-widget-image" >
                                                    <div class="elementor-widget-container">
                                                        <div class="elementor-image">
                                                            ...
                                                            <img src="frontend/assets/new/images/index/logo.png" width="228" height="54" class="attachment-full size-full" alt="Lien Hoe Corporation Berhad"></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
								   ...
								   <!--<li class="menu-item"><a href="<?php echo 'cms/ceomessage'; ?>">CEO's Message</a></li>-->	                                                                    
  								   <li class="menu-item"><a href="<?php echo 'cms/profile'; ?>">Corporate Profile</a></li>
                            			...
                            			<li class="menu-item"><a href="<?php echo 'bursa/investorrelations/managementanalysis/whistleblowerpolicy'; ?>">Whistleblowing Policy</a></li>
                                                                  ...
                                                                  <li class='menu-item current-menu-item'><a href="<?php echo 'bursa/investorrelations/reports/prospectus'; ?>">AGM/EGM</a></li>
                                                                ...
                                                                <div class="elementor-widget-container">
                                                                    <div class="elementor-text-editor elementor-clearfix">
                                                                        <div class="lqd-lines split-unit lqd-unit-animation-done">
                                                                            Lien Hoe Corporation Berhad is a progressive and well-established public listed company with diversified businesses.
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="elementor-column-wrap elementor-element-populated">
                                                    <div class="elementor-widget-wrap">
                                                        ...
                                                        <div class="elementor-element elementor-element-7c720c1 elementor-widget__width-inherit elementor-widget-mobile__width-inherit elementor-widget elementor-widget-heading" data-id="7c720c1" data-element_type="widget" data-settings="{&quot;avante_ext_is_smoove&quot;:&quot;true&quot;,&quot;avante_ext_smoove_disable&quot;:&quot;769&quot;,&quot;avante_ext_smoove_duration&quot;:1000,&quot;avante_ext_smoove_rotatex&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:-90,&quot;sizes&quot;:[]},&quot;avante_ext_smoove_translatey&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:40,&quot;sizes&quot;:[]},&quot;avante_ext_smoove_translatez&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:-140,&quot;sizes&quot;:[]},&quot;avante_ext_is_scrollme&quot;:&quot;false&quot;,&quot;avante_ext_smoove_scalex&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:1,&quot;sizes&quot;:[]},&quot;avante_ext_smoove_scaley&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:1,&quot;sizes&quot;:[]},&quot;avante_ext_smoove_rotatey&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:0,&quot;sizes&quot;:[]},&quot;avante_ext_smoove_rotatez&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:0,&quot;sizes&quot;:[]},&quot;avante_ext_smoove_translatex&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:0,&quot;sizes&quot;:[]},&quot;avante_ext_smoove_skewx&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:0,&quot;sizes&quot;:[]},&quot;avante_ext_smoove_skewy&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:0,&quot;sizes&quot;:[]},&quot;avante_ext_smoove_perspective&quot;:{&quot;unit&quot;:&quot;px&quot;,&quot;size&quot;:1000,&quot;sizes&quot;:[]},&quot;avante_ext_is_parallax_mouse&quot;:&quot;false&quot;,&quot;avante_ext_is_infinite&quot;:&quot;false&quot;}" data-widget_type="heading.default">
                                                            <div class="elementor-widget-container">
                                                                <h2 class="elementor-heading-title elementor-size-default">Charts</h2>
                                                            </div>
                                                        </div>
                        ...
                        <div class="elementor-container elementor-column-gap-default">
							...
							<a href="https://www.linkedin.com/company/majuperakholdingsberhad" class="elementor-icon elementor-social-icon elementor-social-icon-linkedin elementor-repeater-item-a9fc5ce" target="_blank">
                                            ...
                                            <div class="elementor-element elementor-element-01821a2 elementor-widget elementor-widget-heading"  data-element_type="widget"  data-widget_type="heading.default">
                                                <div class="elementor-widget-container">
                                                    <span class="elementor-heading-title elementor-size-default">Copyright 2024 Lien Hoe Corporation Bhd 196901000161 (8507-X). All Rights Reserved.<br/> <a href="http://www.webqom.com/services/responsive_web_design" target="_blank">Web Design Malaysia</a> &amp; <a href="http://www.webqom.com/services/shared_hosting" target="_blank">Web Hosting Malaysia</a></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<!--<script type="text/javascript" src="https://code.highcharts.com/stock/highstock.js"></script>-->
   <script type="text/javascript" src="frontend/js/highstock.js"></script>
