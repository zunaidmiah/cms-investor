            ...
            <div class="portlet-header">
              ...
              <div class="btn-group">
                ...
                <ul role="menu" class="dropdown-menu">
                  <li><a href="#" data-target="" onclick="app_selected_form()" data-toggle="modal">Delete selected item(s)</a></li>
                  <li class="divider"></li>
              ...
              <table class="table table-hover table-striped">
                ...
                <tbody>
                  <form id="app_selected_form" action="{{URL::to('app_selected_del')}}" method="post">
                   ...
                   <tr>
                    <td><input type="checkbox" name="checkbox[]" value="{{$online->id}}"/></td>
                    <td>{{$online->id}}</td>
