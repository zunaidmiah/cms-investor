                ...
                <div class="portlet-header">
                  ...
                  <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu">
                      <li><a href="#" data-target="#modal-delete-selected" onclick="submit_form()" data-toggle="modal">Delete selected item(s)</a></li>
                      <li class="divider"></li>
                ...
                <div class="portlet-body">
                  <div class="form-inline pull-left">
                    ...
                    <form id="set_page" action="{{URL::to('set_page')}}" method="post">
                      <select name="id" onchange="this.form.submit()" id="on_change" class="form-control">
                        ...
                        <option selected="selected">{{Session::get('per_page')}}</option>
                        @else
                        <option>10</option>
                        @endif
                        <option>50</option>
                  ...
                  <table class="table table-hover table-striped">
                    ...
                    <form id="del_id" action="{{URL::to('montage_del_id')}}" method="post" >
                      ...
                      <tr>
                        <td><input type="checkbox" name="del[]" value="{{$montage->id}}"/></td>
                        <td>{{$montage->id}}</td>
