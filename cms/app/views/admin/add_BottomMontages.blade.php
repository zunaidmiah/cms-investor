...
<!--BEGIN PAGE WRAPPER-->
<!--END CONTENT-->
         <!--Modal Add New BottomMontage start-->
     <div id="page-wrapper">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 id="modal-login-label2" class="modal-title">Add New Bottom Montage</h4>
                        </div>
                        <div class="modal-body">

                             {{ Form::open(array('name'=>'BottomMontages_add_form','id'=>'BottomMontages_add_form','url' => 'BottomMontage',"method" => "post","files"=>true,"class"=>"form-horizontal")) }}
                             {{ Form::hidden('BottomMontage_banner_text') }}
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  ...
                                  <div id="BottomMontage_banner_text" contenteditable="true">
                                        <div class="row-fluid red_text">
         ...
         <!--END MODAL Add New BottomMontage-->
         <!--Modal delete start-->
