                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <optgroup label="CMS">
                                      <option value="">-Corporate Information</option>
                                        ...
                                        <option value="158">-Directors’ Fit and Proper Policy</option>
                                        <option value="500">-sustainability - palm-oil-policy</option>
                                        
                                        <option value="501">-sustainability - Environmental-protection-biological-diversity-policy</option>
                                        
                                        
                                        <option value="502">-sustainability - equality-gender-policy</option>
                                        
                                        <option value="503">-sustainability - food-safety-policy</option>
                                        
                                         
                                        
                                        <option value="504">-sustainability - quality-policy</option>
                                        
                                        
                                       
                                        
                                        <option value="505">-sustainability - safety-health-policy</option>
                                        
                                        
                                        <option value="506">-sustainability - safety-policy</option>
                                        
                                        
                                        <option value="507">-sustainability  - slope-river-protection-policy</option>
                                        
                                        
                                        
                                        <option value="508">-investorrelations- financialinformation/equitychanges</option>
                                        
                                        
                                        <option value="509">-investorrelations- financialinformation/cashflowstatement</option>
                                        
                                        
                                          <option value="510">-investorrelations- financialinformation/risk_management_committee</option>
                                      
                                      
                                          <option value="511">-investorrelations- corporateinformation/ourproperties</option>
                                          
                                          
                                            <option value="512">-investorrelations- financialinformation/remuneration_committee</option>
                                      
                                        <option value="1">&nbsp; --Corporate Profile</option>
                                        <option value="160">&nbsp; --CEO Message</option>
                                        ...
                                        <option value="167">&nbsp; Summary of Shareholders' Voting Rights</option>
                                        <option value="168">&nbsp; eDividend</option>
                                         

                                        <option value="">-CORE BUSINESS</option>
                                        <option value="10">&nbsp; Property Development &amp; Infrastructure</option> 
                                        <option value="9">&nbsp; Strategic Business</option> 
                                        <option value="11">&nbsp; Land, Asset &amp; Facility Management</option> 
                                    ...
                                    <optgroup label="Bursa">
                                       <option value="62">-Home</option>
                                        <option value="">-Corporate Information</option>
                                        <option value="20">&nbsp; --Statutory Information</option>
                                        <option value="21">&nbsp; --Board of Directors</option>
                                        <option value="22">&nbsp; --Management Team</option>
                                        <!--<option value="23">&nbsp; --Audit and Risk Management Committee</option>-->
                                        <!--<option value="24">&nbsp; --Our Subsidiaries</option>-->
										<option value="42">&nbsp; --Anti-Bribery & Anti-Corruption Policy</option>
                                        <option value="166">-External Auditors Assessment Policy</option>
										<option value="164">-Gender Diversity Policy</option>
										<option value="165">-Remuneration Policy</option>
                                        <option value="159">-Code of Business Conduct & Ethics</option>
										<option value="46">-Whistle Blower Policy</option>
                                        <option value="">-Estate Information</option>
                                        <option value="27">&nbsp; --Estate Location</option>
                                        <option value="28">&nbsp; --Estate Profile</option>
                                        ...
                                        <option value="36">&nbsp; --Shareholders</option>
                                        <!--<option value="37">-Entitlements</option>-->
                                        <option value="">-Financial Information</option>
                                        <option value="38">&nbsp; --Financial Statistics</option>
                                        <option value="39">&nbsp; --Statements of Comprehensive Income</option>
                                        <option value="40">&nbsp; --Statements of Financial Position</option>
                                        <!--<option value="41">&nbsp; --Cash Flow Statement</option>-->
                                        <option value="43">&nbsp; --Key Audit Matters</option>
                                        <option value="44">&nbsp; --Highlights</option>
                                        <option value="45">&nbsp; --Production Statistics</option>
                                        <option value="">-Governance</option>
                                        <option value="26">&nbsp; --Corporate Governance</option>
                                        <option value="47">&nbsp; --Board Charter</option>
                                        <option value="170">&nbsp; --Nomination Committee</option>
                                      
                                        <option value="155">&nbsp; --Audit Management Committee</option>
                                        <option value="156">&nbsp; --Risk Management Committee</option>
                                        <option value="24">&nbsp; --Remuneration Committee</option>

                                        <!--<option value="48">&nbsp; --Past Performance Review</option>-->

                                        <option value="">-News Centre</option>
                                        <option value="49">&nbsp; --Bursa Announcements</option>
                                        <option value="157">&nbsp; --Bursa Announcements Duplicate</option>
                                        ...
                                        <option value="175">&nbsp; --investorrelations/frontadditionallistingsubdivision</option>
                                        <option value="176">&nbsp; --investorrelations/frontadditionallistingsubdivisiondetail</option>
                                        ...
                                        <option value="171">&nbsp; --Notice of Interest of Substantial Shareholder Pursuant to Section 137 of CA 2016 - List</option>
                                        <option value="172">&nbsp; --Notice of Interest of Substantial Shareholder Pursuant to Section 137 of CA 2016 - Detail</option>
                                        <option value="173">&nbsp; --Change in the Interest of Substantial Shareholder Pursuant to Section 138 of CA 2016 - List</option>
                                        <option value="174">&nbsp; --Change in the Interest of Substantial Shareholder Pursuant to Section 138 of CA 2016 - Detail</option>
                                        ...
                                        <option value="55">&nbsp; --AGM/EGM/MSWG</option>
                                        ...
                                        <option value="">-CONTACT US</option>
                                          ...
                                          <option value="100">
                                           -- grievancereportslisting
                                          </option>

                                           <option value="101">
                                            --grievanceform                                          </option>
...
//var_dump($pageArray);
 ...
 ?>
                                      ...
                                      <option value="">-Corporate Information</option>
                                        ...
                                        <option {{ in_array(160,$pageArray)?'selected':'' }} value="160">&nbsp; --CEO Message</option> 
                                        ...
                                        <option {{ in_array(167,$pageArray)?'selected':'' }} value="167">-Summary of Shareholders’ Voting Rights</option> 
                                        <option {{ in_array(168,$pageArray)?'selected':'' }} value="168">-eDividend</option> 
                                        <option {{ in_array(158,$pageArray)?'selected':'' }}  value="158">-Directors’ Fit and Proper Policy</option>     
                                        <option {{ in_array(500,$pageArray)?'selected':'' }}  value="500">-sustainability - palm-oil-policy</option>
                                        
                                        <option {{ in_array(501,$pageArray)?'selected':'' }}  value="501">-sustainability - Environmental-protection-biological-diversity-policy</option>
                                        
                                        
                                        <option {{ in_array(502,$pageArray)?'selected':'' }}  value="502">-sustainability - equality-gender-policy</option>
                                        
                                        <option {{ in_array(503,$pageArray)?'selected':'' }}  value="503">-sustainability - food-safety-policy</option>
                                        
                                         
                                        
                                        <option {{ in_array(504,$pageArray)?'selected':''}}  value="504">-sustainability - quality-policy</option>
                                        
                                        
                                       
                                        
                                        <option {{ in_array(505,$pageArray)?'selected':'' }}  value="505">-sustainability - safety-health-policy</option>
                                        
                                        
                                        <option {{ in_array(506,$pageArray)?'selected':'' }}  value="506">-sustainability - safety-policy</option>
                                        
                                        
                                        <option {{ in_array(507,$pageArray)?'selected':'' }}  value="507">-sustainability  - slope-river-protection-policy</option>
                                        
                                        
                                        
                                        <option {{ in_array(508,$pageArray)?'selected':'' }} value="508">-investorrelations- financialinformation/equitychanges</option>
                                        
                                        
                                        <option {{ in_array(509,$pageArray)?'selected':'' }}  value="509">-investorrelations- financialinformation/cashflowstatement</option>
                                        
                                        
                                          <option {{ in_array(510,$pageArray)?'selected':'' }}  value="510">-investorrelations- financialinformation/risk_management_committee</option>
                                      
                                      
                                          <option {{ in_array(511,$pageArray)?'selected':''}}  value="511">-investorrelations- corporateinformation/ourproperties</option>
                                          
                                          
                                            <option {{ in_array(512,$pageArray)?'selected':''}}  value="512">-investorrelations- financialinformation/remuneration_committee</option>

                                        <option value="">-CORE BUSINESS</option>
                                        <option {{ in_array(10,$pageArray)?'selected':'' }} value="10">&nbsp; Property Development &amp; Infrastructure</option>
                                        <option {{ in_array(9,$pageArray)?'selected':'' }} value="9">&nbsp; Strategic Business</option> 
                                        <option {{ in_array(11,$pageArray)?'selected':'' }} value="11">&nbsp; Land, Asset &amp; Facility Management</option> 
                                    ...
                                    <optgroup label="Bursa">
                                        ...
                                        <option value="">-Corporate Information</option>
                                        <option {{ in_array(20,$pageArray)?'selected':'' }} value="20">&nbsp; --Statutory Information</option>
                                        <option {{ in_array(21,$pageArray)?'selected':'' }} value="21">&nbsp; --Board of Directors</option>
                                        <option {{ in_array(22,$pageArray)?'selected':'' }} value="22">&nbsp; --Management Team</option>
                                        <!--<option {{ in_array(23,$pageArray)?'selected':'' }} value="23">&nbsp; --Audit and Risk Management Committee</option> -->
                                        <!--<option {{ in_array(24,$pageArray)?'selected':'' }} value="24">&nbsp; --Our Subsidiaries</option>-->
                                        <option {{ in_array(42,$pageArray)?'selected':'' }} value="42">&nbsp; --Anti-Bribery & Anti-Corruption Policy>
										<option {{ in_array(166,$pageArray)?'selected':'' }} value="166">-External Auditors Assessment Policy</option>
										<option {{ in_array(164,$pageArray)?'selected':'' }} value="164">-Gender Diversity Policy</option>
										<option {{ in_array(165,$pageArray)?'selected':'' }} value="165">-Remuneration Policy</option>
                                        <option {{ in_array(159,$pageArray)?'selected':'' }} value="159">-Code of Business Conduct & Ethics</option>
										<option {{ in_array(46,$pageArray)?'selected':'' }} value="46">-Whistle Blower Policy</option>
                                        <option value="">-Estate Information</option>
                                        <option {{ in_array(27,$pageArray)?'selected':'' }} value="27">&nbsp; --Estate Location</option>
                                        <option {{ in_array(28,$pageArray)?'selected':'' }} value="28">&nbsp; --Estate Profile</option>
                                        ...
                                        <option {{ in_array(36,$pageArray)?'selected':'' }} value="36">&nbsp; --Shareholders</option>
                                        <!--<option {{ in_array(37,$pageArray)?'selected':'' }} value="37">-Entitlements</option>-->
                                        <option  value="">-Financial Information</option>
                                        <option {{ in_array(38,$pageArray)?'selected':'' }} value="38">&nbsp; --Financial Statistics</option>
                                        <option {{ in_array(39,$pageArray)?'selected':'' }} value="39">&nbsp; --Statements of Comprehensive Income</option>
                                        <option {{ in_array(40,$pageArray)?'selected':'' }} value="40">&nbsp; --Statements of Financial Position</option>
                                        <!--<option {{ in_array(41,$pageArray)?'selected':'' }} value="41">&nbsp; --Cash Flow Statement</option>-->
                                        <option {{ in_array(43,$pageArray)?'selected':'' }} value="43">&nbsp; --Key Audit Matters</option>
                                        <option {{ in_array(44,$pageArray)?'selected':'' }} value="44">&nbsp; --Highlights</option>
                                        <option {{ in_array(45,$pageArray)?'selected':'' }} value="45">&nbsp; --Production Statistics</option>
                                        <option  value="">-Governance</option>
                                        <option {{ in_array(26,$pageArray)?'selected':'' }} value="26">&nbsp; --Corporate Governance</option>
                                        <option {{ in_array(47,$pageArray)?'selected':'' }} value="47">&nbsp; --Board Charter</option>
                                        <option {{ in_array(170,$pageArray)?'selected':'' }} value="170">&nbsp; --Nomination Committee</option>
                                        <option {{ in_array(155,$pageArray)?'selected':'' }} value="155">&nbsp; --Audit Management Committee</option>
                                        <option {{ in_array(156,$pageArray)?'selected':'' }} value="156">&nbsp; --Risk Management Committee</option>
                                        <option {{ in_array(24,$pageArray)?'selected':'' }} value="24">&nbsp; --Remuneration Committee</option>
                                        ...
                                        <option {{ in_array(157,$pageArray)?'selected':'' }} value="157">&nbsp; --Bursa Announcements Duplicate</option>
                                        <option value="">-Bursa Announcements details</option>
                                        ...
                                        <option {{ in_array(175,$pageArray)?'selected':'' }} value="175">&nbsp; --investorrelations/frontadditionallistingsubdivision</option>
                                        <option {{ in_array(176,$pageArray)?'selected':'' }} value="176">&nbsp; --investorrelations/frontadditionallistingsubdivisiondetail</option> 
                                        ...
                                        <option {{ in_array(171,$pageArray)?'selected':'' }} value="171">&nbsp; --Notice of Interest of Substantial Shareholder Pursuant to Section 137 of CA 2016 - List</option>
                                        <option {{ in_array(172,$pageArray)?'selected':'' }} value="172">&nbsp; --Notice of Interest of Substantial Shareholder Pursuant to Section 137 of CA 2016 - Detail</option>
                                        <option {{ in_array(173,$pageArray)?'selected':'' }} value="173">&nbsp; --Change in the Interest of Substantial Shareholder Pursuant to Section 138 of CA 2016 - List</option>
                                        <option {{ in_array(174,$pageArray)?'selected':'' }} value="174">&nbsp; --Change in the Interest of Substantial Shareholder Pursuant to Section 138 of CA 2016 - Detail</option>
                                        ...
                                        <option {{ in_array(55,$pageArray)?'selected':'' }} value="55">&nbsp; --AGM/EGM/MSWG</option>
                                        ...
                                        <option {{ in_array(100,$pageArray)?'selected':'' }} value="100">-- grievancereportslisting</option>

                                             
                                 <option {{ in_array(101,$pageArray)?'selected':'' }} value="101">--grievanceform</option>
...
<button type="submit" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a>
        ...
        <!--END CONTENT-->
            ...
            <div class="page-footer">
                <div class="copyright"><span class="text-15px">2022 &copy; <a href="https://www.webqom.com" target="_blank">Webqom Technologies Sdn Bhd.</a> Any queries, please contact <a href="mailto:support@webqom.com">Webqom Support</a>.</span>
