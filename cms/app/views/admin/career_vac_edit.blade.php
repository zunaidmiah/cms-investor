...
@section('content')
    ...
    <div id="page-wrapper">
                ...
                <div class="portlet">
                    <div class="portlet-header">
                        ...
                        <div class="btn-group">
                            ...
                            <ul role="menu" class="dropdown-menu">
                                <li><a href="#" data-target="#modal-delete-selected-items" data-toggle="modal" class="deleteid" rel="{{URL::to('vacancy_selected_del')}}" rev="modal-delete-selected-items">Delete selected item(s)</a></li>
                                <li class="divider"></li>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-actions">
                                            <div class="col-md-offset-4 col-md-8"> <a href="#" onclick="return document.getElementById('vacancy_selected_form').submit()" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="modal-delete-all" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-actions">
	                                	{{ Form::open(array('url' => 'delete_all_vacancy', 'method' => 'post', 'name' => 'deleteallsementra', 'id' => 'deleteallsementra', 'class' => 'form-horizontal','files' => true)) }}
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                <form id="vacancy_selected_form" action="{{URL::to('vacancy_selected_del')}}" method="post">
                                    ...
                                    <tr>
                                        <td><input type="checkbox" class="chkNumber" name="checkbox[]" value="{{$career->id}}"/></td>
                                        <td>{{$career->id}}</td>
                        ...
                        <div class="tool-footer text-right">
                            <p class="pull-left">Showing {{$careers->getFrom()}} to {{$careers->getTo()}} of {{$careers->getTotal()}} entries</p>
                            {{$careers->links()}}
                        </div>
                        <div class="clearfix"></div>
                    </div>
        ...
        <div class="page-footer">
            <div class="copyright">
                <span class="text-15px">2014 © <a href="http://www.webqom.com" target="_blank">Webqom Technologies Sdn Bhd.</a> Any queries, please contact <a href="mailto:support@webqom.com">Webqom Support</a>.</span>
