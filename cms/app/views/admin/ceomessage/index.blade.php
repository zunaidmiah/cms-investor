      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
         ...
         <div class="page-header-breadcrumb">
          ...
          <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active"> {{ strip_tags($ceo_heading) }} - Edit</li>
          </ol>
        </div>
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2> {{ strip_tags($ceo_heading) }} <i class="fa fa-angle-right"></i> Edit</h2>
        ...
        @endif
              ...
              {{ Form::open(array('url' => 'ceo/message/update','class'=> 'form-horizontal','method' => 'post','name' => 'update_ceomessage_heading1')) }}
                {{Form::hidden('preview','')}}
                ...
                <div class="portlet">
                    ...
                    <div class="portlet-body">
                        <div class="info_heading">
                            <div contenteditable="true" id="left-block-ceo-heading1" style="overflow: hidden;" onblur="ceoheading1Submit()">
                                {{ $page->heading1 }}
                            </div>
                            {{ Form::textarea('main_body_1',$page->heading1,array("id" => "textarea-left-block-ceo-heading1","class" => "hideThisField")) }}
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </div>
             ...
             {{ Form::open(array('url' => 'ceo/message/update','class'=> 'form-horizontal','method' => 'post','name' => 'update_core_body1', 'onsubmit' => 'corebody1Submit()')) }}
                {{Form::hidden('preview','')}}
                {{Form::hidden('id',$page->id)}}
                {{Form::hidden('content','body1')}}
                {{Form::hidden('type',$page->type)}}

                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">Banner Description</div>
                            <br/>
                            <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"> <i class="fa fa-chevron-up"></i> </div>
                    </div>
                    <div class="portlet-body">
                        <div class="info_heading">
                          <div contenteditable="true" id="left-body1-content" style="overflow: hidden;">
                            {{ $page->body1 }}
                           </div>
                          {{ Form::textarea('body1',$page->body1 ,array("id" => "textarea-left-body1-content","class" => "hideThisField")) }}
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </div>
             ...
             {{ Form::open(array('url' => 'ceo/message/update','class'=> 'form-horizontal','method' => 'post','name' => 'update_ceomessage_heading2', 'onsubmit' => 'ceoheading2Submit()')) }}
                {{Form::hidden('preview','')}}
                {{Form::hidden('id',$page->id)}}
                ...
                <div class="portlet">
                    ...
                    <div class="portlet-body">
                        <div class="info_heading">
                          ...
                          {{ Form::textarea('main_body_2',$page->heading2,array("id" => "textarea-left-heading2-content","class" => "hideThisField")) }}
                          <div class="clearfix"></div>
                        </div>
                    </div>
                </div>
             ...
             {{ Form::open(array('url' => 'ceo/message/update','class'=> 'form-horizontal','method' => 'post','name' => 'update_core_body2', 'onsubmit' => 'corebody2Submit()')) }}
                {{Form::hidden('preview','')}}
                {{Form::hidden('id',$page->id)}}
                ...
                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">Page Description 1</div>
                            <br/>
                            <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"> <i class="fa fa-chevron-up"></i> </div>
                    </div>
             ...
             {{ Form::open(array('url' => 'ceo/message/update','class'=> 'form-horizontal','method' => 'post','name' => 'update_core_body3', 'onsubmit' => 'corebody3Submit()')) }}
                {{Form::hidden('preview','')}}
                {{Form::hidden('id',$page->id)}}
                {{Form::hidden('content','body3')}}
                {{Form::hidden('type',$page->type)}}

                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">Page Description 2</div>
                            <br/>
                            <span class="text-blue text-12px">You can edit the content by clicking the text section below.</span>
                        <div class="tools"> <i class="fa fa-chevron-up"></i> </div>
                    </div>
                    <div class="portlet-body">
                        <div class="info_heading">
                          <div contenteditable="true" id="left-body3-content" style="overflow: hidden;">
                            {{ $page->body3 }}
                           </div>
                          {{ Form::textarea('body3',$page->body3 ,array("id" => "textarea-left-body3-content","class" => "hideThisField")) }}
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </div>
             ...
             {{ Form::close() }}
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">{{ strip_tags($ceo_heading) }} - Edit</div>
                  <br/>
                  ...
                  <div id="modal-add-core-sub" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog modal-wide-width">
                      <div class="modal-content">
                        ...
                        <div id="msgadd"></div>
                          <div class="form">
                            {{ Form::open(array('name'=>'add_form','id'=>'add_form','url' => 'ceo/image/add',"method" => "post","files"=>true,"class"=>"form-horizontal")) }}
                              {{Form::hidden('type',$page->type)}}
                              ...
                              <!--<div class="form-group">
                                ...
                                <h2 class="red-title">Title of CEO Message</h2>
                                </div>
                              ...
                              <div class="form-group">
                                <label class="col-md-3 control-label">CEO Image<span class='require'>*</span></label>
                                <div class="col-md-9">
   ...
   {{ Form::close() }}
                  ...
                  <table class="table table-hover table-striped">
                    ...
                    @foreach ($CoreSubs as $CoreSub)
                      <tr>
                        ...
                        <td>{{ strip_tags($CoreSub->image) }}</td>
                        ...
                        <td>
                          <a href="#" data-hover="tooltip" data-placement="top" data-target="#modal-edit-core-sub-{{$CoreSub->id}}" data-toggle="modal" title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>

                          <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-{{$CoreSub->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                            ...
                            <div id="modal-edit-core-sub-{{$CoreSub->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog modal-wide-width">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                    <h4 id="modal-login-label2" class="modal-title">Edit CEO Image</h4>
                                  </div>
                                  <div class="modal-body">
                                  <div id="msgupd{{$CoreSub->id}}"></div>
                                    <div class="form">
                                       {{ Form::open(array('url' => '/ceo/image/update', 'method' => 'post', 'class' => 'form-horizontal','files' => true)) }} 
                                        <div class="form-group">
                                          <label class="col-md-3 control-label">Status</label>
                                          <div class="col-md-9">
                                            <div data-on="success" data-off="primary" class="make-switch">
              ...
              {{Form::checkbox('status',1,$CoreSub->status,array('class' => 'form-control'))}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                              <div class="text-15px margin-top-10px"> <img src='{{ asset("uploads/ceomessage/$CoreSub->image")}}' alt="" class="img-responsive"><br/>
                          ...
                          {{ Form::open(array('url' => '/ceo/image/delete/'.$CoreSub->id,"method" => "post","class"=>"form-horizontal")) }}
                            ...
                            <div id="modal-delete-{{$CoreSub->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                    <h4 id="modal-login-label3" class="modal-title"><a href=""><i class="fa fa-exclamation-triangle"></i></a>Are you sure you want to delete? </h4>
                                  </div>
                                  <div class="modal-body">
                                    <p><strong>#{{$k}}:</strong> {{$CoreSub->image}}</p>
                                    <div class="form-actions">
                                      <div class="col-md-offset-4 col-md-8"> 
...
var ms='<div class="alert alert-success alert-dismissable"><button type="button" data-dismiss="alert" aria-hidden="true" class="close">&times;</button><i class="fa fa-check-circle"></i> <strong>Success!</strong><p>Updated Successfully</p></div>';
  ...
  function ceoheading1Submit(){
      var heading_1 = $('#left-block-ceo-heading1').html();
      $('#textarea-left-block-ceo-heading1').text(heading_1);
  }
  function ceoheading2Submit(){

    var heading_2 = $('#left-heading2-content').html();
       
      $('#textarea-left-heading2-content').text(heading_2);
      
  }

  function corebody2Submit(){
 
      var text_content = $('#left-body2-content').html();
        
      $('#textarea-left-body2-content').text(text_content);
     
  }

  function corebody1Submit(){
 
      var body1 = $('#left-body1-content').html();
        
      $('#textarea-left-body1-content').text(body1);
     
  }

  function corebody3Submit(){
 
      var body3 = $('#left-body3-content').html();
        
      $('#textarea-left-body3-content').text(body3);
