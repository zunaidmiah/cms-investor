        ...
        <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
                                  ...
                                  <div class="thumbnail">
                                    <div class="caption-head">
                                      <a href="#" data-placement="top" data-target="#modal-edit-core-business-{{$Busi->id}}" data-toggle="modal" title="Edit">
                                        {{-- <a href="#" data-placement="top" data-target="#modal-edit-core-business-{{$Busi->id}}" data-toggle="modal" title="Edit"> --}}
                                          <img src="{{ URL::asset('uploads/corporates/'.$Busi->image) }}" alt="image" style="width:45%; padding-top: 40px;" class="img-responsive">
                                          <h6 class="caption-title">{{$Busi->title}}</h6>
                                      </a>
              ...
              {{ Form::open(array('id'=>'corporate_information_page_edit', 'name'=>'corporate_information_page_edit','url' => 'save_corporate_informations',"method" => "post","class"=>"form-horizontal")) }}
              ...
              <div class="portlet">
                ...
                <div class="info_resalt border_top">
                        ...
                        <div class="row text-center service-process">
                            <div class="info_vertical">
                                <div  contenteditable="true">
                                	<h2 class="red-title3">{{$page->heading3}}</h2>
                                </div>
                                <div id="body3" contenteditable="true">
                                	{{$page->body3}}
                                </div>
                            </div>
                            <br/>
                            <!-- Step 1 -->
                            @foreach ($corporate_information_create as $Busi)
                            {{-- @foreach ($businesses_create as $Busi) --}}
                              <div class="col-lg-3">
                                  <div class="thumbnail">
                                    <div class="caption-head">

                                          <a href="#" data-placement="top" data-target="#modal-edit-core-business-new-{{$Busi->id}}" data-toggle="modal" title="Edit">
                                            {{-- <a href="#" data-placement="top" data-target="#modal-edit-core-business-{{$Busi->id}}" data-toggle="modal" title="Edit"> --}}
                                              <img src="{{ URL::asset('uploads/corporates/'.$Busi->image) }}" alt="image" style="width:25%; padding-top: 40px;" class="img-responsive">
                                              <h6 class="caption-title">{{$Busi->title}}</h6>
                                          </a>
                                    </div>
                                  </div>
              ...
              @foreach ($businesses_create as $Busi)
                  ...
                  <div class="modal-dialog modal-wide-width">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                       {{ Form::open(array('url' => 'businesses_update/'.$Busi->id,"method" => "post","files"=>true,"class"=>"form-horizontal")) }}
                        <div class="form">
                          <form class="form-horizontal">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6">
                                  {{ Form::textarea('title', $Busi->title, array('class'=>'form-control',"rows"=>'1')) }}

                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-md-3 control-label">Text <span class='require'>*</span></label>
                              <div class="col-md-6">
                                  {{ Form::textarea('text', $Busi->text, array('class'=>'form-control',"rows"=>'2')) }}
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6">
                                   <div class="text-15px margin-top-10px">
                                    <img src="{{ URL::asset('uploads/corporates/'.$Busi->image) }}" alt="image" class="img-responsive"><br/>
                                    {{ Form::file('image');}}
                                    <br/>
               ...
               @endforeach
               @foreach ($corporate_information_create as $Busi)
                <div id="modal-edit-core-business-new-{{$Busi->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                  <div class="modal-dialog modal-wide-width">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                        <h4 id="modal-login-label2" class="modal-title">Edit Corporate Information</h4>
                      </div>
                      <div class="modal-body">
                       {{ Form::open(array('url' => 'corporate_information_update/'.$Busi->id,"method" => "post","files"=>true,"class"=>"form-horizontal")) }}
                        <div class="form">
                          <form class="form-horizontal">
...
@endforeach
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Bottom Montage Listing</div>
                  <br/>
                  <p class="margin-top-10px"></p>
                  <a href="{{ URL::to('Add_BottomMontages') }}" data-target="" data-toggle="modal" class="btn btn-success">Add New BottomMontage &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                  <div class="btn-group">
                    <button type="button" class="btn btn-primary">Delete</button>
                    <button type="button" data-toggle="dropdown" class="btn btn-red dropdown-toggle"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
                    <ul role="menu" class="dropdown-menu">
                      <li><a href="#" data-target="#modal-bottom-delete-selected" data-toggle="modal" class="deleteid" rel="{{URL::to('BottomMontage_del_id')}}" rev="modal-bottom-delete-selected">Delete selected item(s)</a></li>
                      <li class="divider"></li>
                      <li><a href="#" data-target="#modal-bottom-delete-all" data-toggle="modal">Delete all</a></li>
                    </ul>
                  </div>
                   
				           <div class="tools">
                  ...
                  <!--Modal delete selected items start-->
                    <div id="modal-bottom-delete-selected" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                  ...
                  <!-- modal delete selected items end -->
                  <!--Modal delete all items start-->
                  <div id="modal-bottom-delete-all" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                ...
                <div class="portlet-body">
                  <div class="form-inline pull-left">
                    <div class="form-group">
                    <form id="set_page" action="{{URL::to('set_page_two')}}" method="post">
                      <select name="id" onchange="this.form.submit()" id="on_change_two" class="form-control">
                         <option value="5">5</option>
                  ...
                  <table class="table table-hover table-striped">
                    ...
                    <form id="del_id" action="{{URL::to('BottomMontage_del_id')}}" method="post" >
                       <?php $i_two = $incr_two; ?> @foreach ($BottomMontages as $BottomMontage)
                      <tr>
                        <td><input type="checkbox" name="del[]" value="{{$BottomMontage->id}}" class="subcheckbox" /></td>
                        <td>{{$i_two + 1}}</td>
                        <td><span class="label label-sm @if($BottomMontage->status == 1) label-success @else label-danger @endif">@if($BottomMontage->status == 1) Active @else Inactive @endif</span></td>
                        <td>{{$BottomMontage->title}}</td>
                        <td>
                            <a href="edit_BottomMontages/{{$BottomMontage->id}}" data-hover="tooltip" data-placement="top"  title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>
                            <a href="deleteBottomMontage/{{$BottomMontage->id}}" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-{{$BottomMontage->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                        </td>
                      </tr>
                      <?php $i_two++; ?>
                       @endforeach
                  ...
                  <div class="tool-footer text-right">
                    <p class="pull-left">Showing {{$start_two}} to {{$end_two}} of {{$total_two}} entries</p>

                    {{$BottomMontages->links()}}
                    <!-- <ul class="pagination pagination mtm mbm">
                      <li class="disabled"><a href="#">&laquo;</a></li>
                      <li class="active"><a href="#">1</a></li>
                        <li><a href="#">2</a></li>
...
<!--Modal delete start-->
@foreach ($BottomMontages as $BottomMontage)
   {{ Form::open(array('url' => 'deleteBottomMontage/'.$BottomMontage->id,"method" => "post","class"=>"form-horizontal")) }}
    <div id="modal-delete-{{$BottomMontage->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                     <div class="modal-dialog">
                       <div class="modal-content">
                         <div class="modal-header">
                           <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
...
<?php } ?>
<?php if (Session::has('per_page_two')) { ?>

console.log("<?php echo Session::get('per_page_two') ?>");
$("#on_change_two").val("<?php echo Session::get('per_page_two') ?>");
