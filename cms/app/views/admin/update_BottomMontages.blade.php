...
{{ Form::open(array('name'=>'BottomMontages_edit','id'=>'BottomMontages_edit_form','url' => 'update_eBottomMontage/'.$BottomMontage->id,"method" => "post","files"=>true,"class"=>"form-horizontal")) }}

     <div id="page-wrapper">
             <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                      <h4 id="modal-login-label2" class="modal-title">Edit BottomMontage</h4>
                    </div>
                      ...
                      <div class="form">
                        <form class="form-horizontal">
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <div data-on="success" data-off="primary" class="make-switch">
                                   @if($BottomMontage->status == 1) <?php $checked = true ?> @else <?php  $checked = false ?> @endif
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                                {{ Form::text('title', $BottomMontage->title, array('placeholder' => 'Title','class'=>'form-control',"required")) }}
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                             <div data-on="success" data-off="primary" class="make-switch">
                                 @if($BottomMontage->MoreStatus == 1) <?php $checked = true ?> @else <?php  $checked = false ?> @endif
                                {{ Form::checkbox('morestatus', '1', $checked);}}
                              </div>

                              <div class="input-icon margin-top-10px"><i class="fa fa-link"></i>
                                   {{ Form::text('url', $BottomMontage->url, array('placeholder' => 'http://','class'=>'form-control')) }}
