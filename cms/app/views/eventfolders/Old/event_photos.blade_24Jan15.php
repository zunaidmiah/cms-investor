      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
        ...
        <div class="page-header-breadcrumb">
          ...
          <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active">News &amp; Events - Photos</li>
          </ol>
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>News &amp; Events <i class="fa fa-angle-right"></i> Photos</h2>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">News &amp; Events Photo Listing</div>
                  <br/>
                  <p class="margin-top-10px"></p>
                  <a href="#" data-target="#modal-add-event-folder" data-toggle="modal" class="btn btn-success">Add New Event Photos &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                  <div class="btn-group">
                    ...
                    <div class="modal-dialog modal-wide-width">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 id="modal-login-label2" class="modal-title">Events Photos</h4>
                        </div>
                          ...
                          <div class="form">
                            <form class="form-horizontal" method="post"  action="{{URL::to('upload_event_photos')}}" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                <label class="col-md-3 control-label">Upload Event Photos <span class='require'>*</span></label>
                                <div class="col-md-9">
                ...
                <div class="portlet-body">
                  ...
                  <p class="pull-right">Showing {{$start}} to {{$end}} of {{$count}} entries  </p>
                  <div class="clearfix"></div>
                   ...
                   @foreach($eventfolders as $key => $value)
                    <div class="col-lg-4">
                      <div class="panel panel-primary">
                        <input type="hidden" name="id" value="{{$id}}">
                        <div class="panel-heading pan">  <img src="{{ URL::asset('uploads/newsevent/'.$value->file) }}" style="width:400px; height:350px;" alt="Event Image" class="img-responsive"> </div>
                        <div class="panel-footer text-center">
                          ...
                          <a href="#" data-hover="tooltip" data-placement="top" data-target="#modal-edit-event-folder-{{$value->id}}" data-toggle="modal" title="Edit Event Folder"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>
                  ...
                  <div id="modal-edit-event-folder-{{ $value->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog modal-wide-width">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                          <h4 id="modal-login-label2" class="modal-title">Image Updation</h4>
                        </div>
                        <div class="modal-body">
