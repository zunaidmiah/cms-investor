      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
        ...
        <div class="page-header-breadcrumb">
          ...
          <ol class="breadcrumb page-breadcrumb">
            ...
            <li><a href="{{url('news_events_list')}}">CSR &amp; Company Bulletin Listing</a>&nbsp; <i class="fa fa-angle-right"></i>&nbsp;</li>
            <li class="active">CSR &amp; Company Bulletin - Photos</li>
          </ol>
          </div>
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>CSR &amp; Company Bulletin <i class="fa fa-angle-right"></i> Photos</h2>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">CSR &amp; Company Bulletin Photo Listing</div>
                  <br/>
