...
<!--BEGIN PAGE WRAPPER-->
    <div id="page-wrapper">
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
                <h2>CSR &amp; Company Bulletin <i class="fa fa-angle-right"></i> Listing</h2>
                ...
                <div class="portlet">
                    <div class="portlet-header">
                        <div class="caption">CSR &amp; Company Bulletin Listing</div>
                        <br/>
                        ...
                        <div class="btn-group">
                            ...
                            <ul role="menu" class="dropdown-menu">
                                <li><a href="#" data-target="#modal-delete-selected-items" data-toggle="modal" class="deleteid" rel="{{URL::to('del_selected_event')}}" rev="modal-delete-selected-items">Delete selected item(s)</a></li>
                                <li class="divider"></li>
                                                    ...
                                                    <div class="col-md-9">
                                                        <div data-on="success" data-off="primary" class="make-switch">
                                                            <select name="category" class="form-control" id="category">
                                                                ...
                                                                <option value="CompanyBulletin">Company Bulletin</option>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-actions">
                                            <div class="col-md-offset-4 col-md-8"> <a href="#" data-dismiss="modal" onclick="return document.getElementById('delete_selected').submit()" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="clearfix"></div>
                        <div class="row">
                            <form id="delete_selected" action="{{URL::to('del_selected_event')}}" method="post">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="panel panel-primary" style="height:400px;">
                                            ...
                                            <div class="panel-footer text-center">
                                                <input type="checkbox" class="chkNumber" name="check_box[]" value="{{ $value->id }}"/>
                                                <a href="{{URL::to('news_events_details/'.$value->id)}}">{{$value->eventtittle}}</a>
                                                <div class="clearfix"></div>
                                                <a href="{{URL::to('news_events_details/'.$value->id)}}" data-hover="tooltip" data-placement="top" title="View All Photos">
                                                ...
                                                <a href="{{$value->id}}" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-{{$value->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a> 
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal" >
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div data-on="success" data-off="primary" class="make-switch">
                                                                {{ Form::checkbox('eventstatus', '1',$value->status);}}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div data-on="success" data-off="primary" class="make-switch">
                                                                <select name="category" class="form-control" id="category">
                                                                    <option value="CompanyBulletin" @if($value->category == 'CompanyBulletin') selected @endif>Company Bulletin</option>
                                                                    <option value="CSR" @if($value->category == 'CSR') selected @endif>CSR</option>
                                                                    <option value="Training" @if($value->category == 'Training') selected @endif>Training</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="page-footer">
                        <div class="copyright"><span class="text-15px">2019 &copy; <a href="http://www.webqom.com" target="_blank">Webqom Technologies Sdn Bhd.</a> Any queries, please contact <a href="mailto:support@webqom.com">Webqom Support</a>.</span>
