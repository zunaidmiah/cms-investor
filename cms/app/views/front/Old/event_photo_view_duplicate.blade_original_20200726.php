                       ...
                       <ul id="portfolio-list">                        
                            ...
                            <li class="span3">                            
                                ...
                                <div class="info">
                                 ...
                                 {{ \Illuminate\Support\Str::limit($data->eventcaption, 150, $end='') }}

                                  @if(str_word_count($data->eventcaption) > 25)
                                    <div class="eye_logo">
                                     <img class="eyeball" src="{{asset('assets/front/img/eye.png')}}"  alt="" style="height: 20px; width: 20px; margin-left: 20px; float: right;"/>
