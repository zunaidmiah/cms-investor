              ...
              <div class="info_vertical">  
                ...
                <div class="span6">
                	<div class="row-fluid">
                      ...
                      <div align="left">
                      	<p><div class="label label-info">{{ date("d M, Y",$latest->date) }}</div> <a href="http://medianews.ock.net.my/news/news_centre_latest_media_news_details?show={{ $latest->id }}" target="_blank">{{ $latest->title }}</a> </p>
                      </div>
                      @endforeach
