                                                                        ...
                                                                        <!--<img width="1260" height="840" src="{{ URL::asset('uploads/slides/'.$BottomMontages[0]->Banner) }}" class="attachment-full size-full" alt="" >-->
                                                         				<div class="blog-post-content-wrapper">
                                                                            ...
                                                                            <div class="col-md-5 col-sm-12 col-xs-12">
                                                                                ...
                                                                                <hr>
                                                                                <div class="card">
                                                                                              <div class="panel-heading"><h3>Share Price</h3></div>
                                                                                              <div class="card-body">
                                                                                ...
                                                                                <li><div class="post-content-wrapper theme-border" style="height: 306px;">
                                                                                	
                                                                                	<div class="panel-heading"><h3>Corporate Calendar</h3></div>
                                                                                    <div class="post-header">
                                                                                       <div class="post-detail single-post">
                                                                                       ...
                                                                                       <div class="post-header-title">
                                                                                          <h7><a href="http://bursa.investor.com.my/investorrelations/frontgeneralmeetingdetail/3101">GENERAL MEETINGS: Outcome of Meeting</a></h7>
                                                                                       </div>
                                                                                    ...
                                                                                    <div class="post-header">
                                                                                       ...
                                                                                       <div class="post-header-title">
                                                                                          <h7><a href="http://bursa.investor.com.my/investorrelations/frontgeneralmeetingdetail/3095">GENERAL MEETINGS: Notice of Meeting</a></h7>
                                                                                       </div>
                                                                                       
                                                                                       <div class="margin_top_20px"></div>
                                                                                       
                                                                                       <div class="elementor-button-wrapper">
                                                                                            <a href="http://bursa.investor.com.my/investorrelations/newscentre/bursaannouncements" class="elementor-button-link elementor-button elementor-size-md" role="button">
                                                                                            <span class="elementor-button-content-wrapper">
                                                                                            <span class="elementor-button-icon elementor-align-icon-right">
                                                                                            <i aria-hidden="true" class="fas fa-long-arrow-alt-right"></i></span>
                                                                        ...
                                                                        <div class="col-md-5 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <ul class="list unstyled">
                                                                               <li><div class="post-content-wrapper">
                                                                               	    <div class="panel-heading"><h3>Latest Annual Report</h3></div>
                                                                                    <div class="post-header">
                                                                               ...
                                                                               <li><div class="post-content-wrapper text-">
                                                                                    <div class="panel-heading"><h3>Latest Quarterly Report</h3></div>
                                                                                    <div class="post-header">
                                                                                        
                                                                                        <div class="post-header-title">
                                                                                            <a href="http://bursa.investor.com.my/system/Report/pdf3s/000/000/037/original/LHC_Q3_2022.pdf" target="_blank"><img src="assets/new/images/index/img_quarterly_report.jpg"></a>
                                                                                        </div>
