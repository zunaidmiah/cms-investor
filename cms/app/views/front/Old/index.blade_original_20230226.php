                                                                               ...
                                                                               <li><div class="post-content-wrapper text-">
                                                                                    ...
                                                                                    <div class="post-header">
                                                                                        ...
                                                                                        <div class="post-header-title">
                                                                                            ...
                                                                                            <a href="{{ URL::to('http://bursa.lienhoecorporationbhd.com/system/Report/pdf4s/000/000/037/original/LHC_Q4_2022.pdf') }}" target="_blank"><img src="assets/new/images/index/img_quarterly_report.jpg"></a>
                                                                                        </div>
                                                                            ...
                                                                            <ul class="list unstyled">
                                                                               <li><div class="post-content-wrapper">
                                                                                    ...
                                                                                    <div class="post-header">
                                                                                        ...
                                                                                        <div class="post-header-title">
                                                                                            <a href="http://bursa.lienhoecorporationbhd.com/system/Report/pdfs/000/000/033/original/LH_AR_2021.pdf" target="_blank"><img src="assets/new/images/annual_report/img2021.jpg"></a>
                                                                                        </div>
                                                                ...
                                                                <div class="elementor-widget-container">
                                                                    <span class="elementor-heading-title elementor-size-default"><!--{{$BottomMontages[0]->body}}-->
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                                                              <tr>
                                                                                <td width="20%" height="70" bgcolor="#015AAA" style="color: #fff; line-height: 18px; padding: 15px 10px; font-size: 16px; text-align: center;" > 23 Feb 2023</td>
                                                                                <td width="10"></td>        
                                                                                <td width="78%"><h7><a href="http://bursa.lienhoecorporationbhd.com/investorrelations/frontfinanciallistingdetail/3104" target="_blank">Quarterly rpt on consolidated results for the financial period ended 31 Dec 2022</a></h7></td>
                                                                              ...
                                                                              <tr>
                                                                                <td width="70" height="70"  bgcolor="#015AAA" style="color: #fff; line-height: 18px; padding: 15px 10px; font-size: 16px; text-align: center; margin-bottom: 20px;">16 Nov 2022</td>
                                                                                <td width="10"></td>
                                                                                <td width="78%"><h7><a href="http://bursa.lienhoecorporationbhd.com/investorrelations/frontgeneralmeetingdetail/3103" target="_blank">Quarterly rpt on consolidated results for the financial period ended 30 Sep 2022</a></h7></td>
