...
<div class="crumbs border_bottom">
        ...
        <section class="content_info"><!-- InstanceBeginEditable name="EditRegion4" -->
          ...
          <div class="info_white1 border_bottom">
            <div class="container">
              <h2 class="red-title">Statement of Corporate Governance</h2>
                                ...
                                <div id="viewpdf">              
                                    <p class="pull-right">View Report Year:
                                        <select onChange="javascript:window.location=this.options[this.selectedIndex].value" name="selector">
                                            ...
                                            <option value="img/corporate_governance/OCK-Corp-Governance-31-12-2013.pdf" selected="selected">31-12-2013</option>
                                            <option value="img/corporate_governance/OCK-Corp-Governance-31-12-2012.pdf">31-12-2012</option>
                                        </select>
                                    </p>
                                    <div class="clearfix"></div>
                                            
                                    <div id="pdf">It appears you don't have Adobe Reader or PDF support in this web browser. <a href="img/corporate_governance/OCK-Corp-Governance-31-12-2013.pdf" target="_blank">Click here to download the PDF</a></div>
                                </div>
                            </div>
                           <!-- end panels -->
                       </div>
