                                ...
                                <div id="viewpdf">              
                                    <p class="pull-right">View Report Year:
                                        <select onChange="javascript:window.location=this.options[this.selectedIndex].value" name="selector">
                                            ...
                                            <option value="img/our_properties/ock-annualreport2013-31122013-06052014-PPT.pdf" selected="selected">31-12-2013</option>
                                            <option value="img/our_properties/ock-annualreport2012-31122012.pdf">31-12-2012</option>
                                        </select>
                                    </p>
                                    <div class="clearfix"></div>
                                            
                                    <div id="pdf">It appears you don't have Adobe Reader or PDF support in this web browser. <a href="img/our_properties/ock-annualreport2013-31122013-06052014-PPT.pdf" target="_blank">Click here to download the PDF</a></div>
                                </div>
                            </div>
                           <!-- end panels -->
                       </div>
