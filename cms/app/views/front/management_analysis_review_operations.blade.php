...
@section('content') 
	...
	var success = new PDFObject({ url: "img/review_operations/ock-annualreport2013-31122013-06052014-OR.pdf" }).embed("pdf");
...
<div class="crumbs border_bottom">
        ...
        <section class="content_info"><!-- InstanceBeginEditable name="EditRegion4" -->
          ...
          <div class="info_white1 border_bottom">
            <div class="container">
              <h2 class="red-title">Management Review</h2>
                                ...
                                <div id="viewpdf">                
                                    <p class="pull-right">View Report Year:
                                        <select onChange="javascript:window.location=this.options[this.selectedIndex].value" name="selector">
                                            ...
                                            <option value="img/review_operations/ock-annualreport2013-31122013-06052014-OR.pdf" selected="selected">31-12-2013</option>
                                            <option value="img/review_operations/ock-annualreport2012-31122012-06052013-OR.pdf">31-12-2012</option>
                                        </select>
                                    </p>
                                    <div class="clearfix"></div>
