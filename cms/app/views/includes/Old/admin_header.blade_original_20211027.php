              ...
              <div class="sidebar-collapse menu-scroll">
                  <ul id="side-menu" class="nav">
                      ...
                      <li  class="{{ Request::is('CoreSub/*') ? 'active' : '' }}"><a href="#"><i class="fa fa-briefcase fa-fw"></i><span class="menu-title">Core Business</span><span class="fa arrow"></span></a>
                          <ul class="nav nav-second-level">
                              <li class="{{ Request::is('CoreSub/core_pdib') ? 'active' : '' }}"><a href="{{URL::to('/CoreSub/core_pdib')}}">Property Development & Infrastruture</a></li>
                              <li class="{{ Request::is('CoreSub/core_sb') ? 'active' : '' }}"><a href="{{URL::to('/CoreSub/core_sb')}}">Strategic Business</a></li>
                              <li class="{{ Request::is('CoreSub/core_lafmb') ? 'active' : '' }}"><a href="{{URL::to('/CoreSub/core_lafmb')}}">Land, Asset & Facility Management</a></li>
                          </ul>
                      </li>
