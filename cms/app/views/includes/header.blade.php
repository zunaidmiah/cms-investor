      ...
      <div class="modal-dialog modal-lg">
         <div class="modal-content">
            <div class="modal-header">
               ...
               <h3 class="modal-title">RELOCATION OF CORPORATE HEAD OFFICE</h3>
            </div>
            <div class="modal-body clearfix">
               <form action="#" method="post" id="comment_form" name="commentForm">
                   Dear Valued Stakeholders and Business Associates,
                   <p>We wish to inform that our Corporate Head Office has been shifted from Bandar Meru Raya to the following new location:</p>
                   <h5>MAJUPERAK HOLDINGS BERHAD</h5>
                   Aras 1, Bazar Ipoh <i>(Previously known as Kompleks Silveritage)</i><br/>
                   Jalan Sultan Nazrin Shah<br/>
                   31350, Ipoh<br/>
                   Perak Darul Ridzuan</p>
                   <p>Telephone: 05-226 2888<br/>
                   Fax: 05-226 2889<br/>
                   Website: <a href="http://cms.majuperak.com/">www.majuperak.com.my</a>
                   <p>We humbly request to mark the change in your records for all future correspondences. Your continuous support is greatly appreciated.</p>
...
<div id="loftloader-wrapper" class="pl-imgloading" data-show-close-time="1500">
    <div class="loader-inner">
        <div id="loader">
            <div class="imgloading-container">
                <span style="background-image: url(images/index/loading_logo.jpg);"></span>
            </div>
            <img alt="loader image" src="/assets/new/images/index/loading_logo.jpg" width="160" height="66" loading="lazy">
        </div>
    </div>
                                            ...
                                            <div class="elementor-element elementor-element-419171e elementor-widget elementor-widget-image" >
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-image">
                                                        <a data-elementor-open-lightbox="" href="{{ URL::to('/') }}">
