...
<li class="menu-item menu-item-has-children arrow"><a href="#">Core Business</a>
   <ul class="sub-menu">
   {{-- <li class="menu-item"><a href="{{ URL::to('core_sub/core_pdib') }}">Building & Civil Works</a></li> --}}
    <li class="menu-item"><a href="{{ URL::to('core_sub/core_sb') }}">Hospitality</a></li>
    <li class="menu-item"><a href="{{ URL::to('core_sub/core_lafmb') }}">Property Development & Investment</a></li>
   </ul>
</li>
