...
//	}
	...
	*/
	...
	public function frontdocumentsubmissiondetail($id)
	{
		$page = Page::where('type','=','cat_documentsubmission')->where('published','=',1)->get();
		$announcement = CrawledAnnounce::where('id','=',$id)->get();
		$pageTitle = "<h1>".$page[0]->page_title."</h1>";
		$masthead = url().'/images/banner_subpage/banner13.jpg';
		$breadcrumbs = array(
				0 => array
		...
		return View::make('frontadditionallistingdetail',array(
				...
				'tagLine' => $tagLine,
				'announcement' => $announcement[0],
				'back_url' => "/investorrelations/newscentre/bursaannouncements"
		)
		);
	}
}
