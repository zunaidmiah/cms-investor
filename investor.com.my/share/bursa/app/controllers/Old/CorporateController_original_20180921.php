...
class CorporateController extends BaseController {
	...
	*/
       ...
       public function DirProfile() {
		...
		return View::make('frontfinancialratioanalysis',array(
          ...
          public function frontBursaAnnounceList() {
                ...
                $announcelists = CrawledAnnounce::where('status','=',1)->orderBy('date_of_publishing', 'DESC')->groupBy('announcement_id')->paginate(5);
	...
	public function Entitlement() {
		...
		$AdditionalListing = CrawledAnnounce::where('category','LIKE', $base_category )->paginate($noperpage);
		if($pgCount > 0)
		{
			$cntarray1 = $cntArr;
		}
