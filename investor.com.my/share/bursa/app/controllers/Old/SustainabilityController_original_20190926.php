...
//Sustainable Fron function 
               ...
               $profieDate = Pdf::select('date')->where('type','=','sust_palm_oil')->where('active','=',1)->orderBy('updated_at','DESC')->distinct()->get();
                ...
                $breadcrumbs = array(
                                    0 => array ("title" => "Home", "url" => ""),
                                     1 => array ("title" => "Investor Relations","url" => ""),
                                    2 => array ("title" => "Governance","url" => ""),
    ...
    // front_sust_certification PDF Viw
        public function front_sust_certification() {
               ...
               $profieDate = Pdf::select('date')->where('type','=','sust_certification')->where('active','=',1)->orderBy('updated_at','DESC')->distinct()->get();
...
// Fron page changing front data 
         public function frontCangingPDF() {
               ...
               $profieDate = Pdf::select('date')->where('type','=',$pdf_type)->where('active','=',1)->orderBy('updated_at','DESC')->distinct()->get();
