...
Route::get('delete_multiple/{array_of_id}', 'HomeController@delete_multiple');
...
Route::post('admin/grienvance_procedure/update/{id}', 'HomeController@update_gravience');
Route::get('grievancereportslisting', 'HomeController@grivance');
Route::get('grievanceform', 'HomeController@grivanceForm');
Route::get('admin/change_grienvance_status/{id}/{status?}', 'HomeController@changeGrienvanceStatus');
Route::get('grievance/verify_email', 'HomeController@verifyEmail');
...
View::composer(array('layouts.front', 'layouts.front_without_banner', 'layouts.front1'), function ($view) {
  if (Request::segment(3) == 'general') {
    ...
    $id = 22;
  } else if (Request::segment(3) == 'tor-remuneration-committee') {
    $id = 24;
  } else if (Request::segment(2) == 'corporategovernance') {
    $id = 26;
  } else if (Request::segment(3) == 'estate_location') {
    $id = 27;
  } else if (Request::segment(3) == 'estate_profile') {
    $id = 28;
  ...
  //end of share information
    ...
    $id = 40;
  } else if (Request::segment(3) == 'b_nominationcommittee') {
    $id = 160;
  } else if (Request::segment(3) == 'b_risk_mgtcommittee') {
    $id = 161;
  } else if (Request::segment(3) == 'b_audit_mgtcommittee') {
    $id = 162;
  } else if (Request::segment(3) == 'b_remuneration_mgtcommittee') {
    $id = 163;
  } else if (Request::segment(3) == 'antibribery_anticorruption') {
    $id = 42;
    ...
    $id = 45;
  } else if (Request::segment(3) == 'whistleblower') {
    $id = 46;
  } else if (Request::segment(3) == 'board_charter') {
    $id = 47;
    ...
    $id = 54;
  } else if (Request::segment(3) == 'agm_egm_mswg') {
    $id = 55;
  ...
  } else if (Request::segment(2) == 'nominationcommitteedetail') //third part end
  {
    ...
    $id = 152;
  } else if (Request::segment(2) == 'tor-board-nomination-committee') {
    $id = 170;
    ...
    $id = 157;
  } else if (Request::segment(2) == 'palm-oil-policy') {
    $id = 158;
  } else if (Request::segment(2) == 'protection-biological-policy') {
    $id = 159;
  } else if (Request::segment(2) == 'equality-gender-policy') {
    $id = 164;
  } else if (Request::segment(2) == 'food-safety-policy') {
    $id = 165;
  } else if (Request::segment(2) == 'quality-policy') {
    $id = 166;
  } else if (Request::segment(2) == 'safety-health-policy') {
    $id = 167;
  } else if (Request::segment(2) == 'safety-policy') {
    $id = 168;
  } else if (Request::segment(2) == 'slope-river-protection-policy') {
    $id = 169;
  } else if (Request::segment(2) == 'social-policy') {
    $id = 171;
  } else if (Request::segment(2) == 'certification-policy') {
    $id = 172;
...
Route::group(["before" => "auth"], function () {
  ...
  Route::get('admin/tor_audit_management_committee', 'SustainabilityController@tor_audit_management');
  Route::get('admin/tor_risk_management_committee', 'SustainabilityController@tor_risk_management');
  ...
  Route::post('admin/dirProfileDeleteMultiple', 'CorporateController@DirProfileDeleteMultiple');
  ...
  Route::get('admin/remunerations', 'CorporateController@Remunerations');
  Route::post('admin/remunerationsadd', 'CorporateController@RemunerationsAdd');
  Route::post('admin/remunerationsdeletemultiple', 'CorporateController@RemunerationsDeleteMultiple');
  Route::get('admin/riskmanagement', 'CorporateController@RiskManagement');
  Route::post('admin/riskmanagementadd', 'CorporateController@RiskManagementAdd');
  Route::post('admin/riskmanagementdeletemultiple', 'CorporateController@RiskManagementDeleteMultiple');
  ...
  Route::get('admin/documentsubmission', 'CorporateController@DocumentSubmission');
  ...
  Route::get('admin/riskcommittee', 'CorporateController@RiskCommittee');
  ...
  Route::post('admin/deleteMultipleReports', 'ReportsController@DeleteMultipleReports');
  ...
  Route::get('admin/exportsubscriver', 'ReportsController@export_subscriber');

  Route::post('admin/addnewsalert', 'ReportsController@AddNewsAlert');
  Route::post('admin/deleteMultipleNewsAlerts', 'ReportsController@DeleteMultipleNewsAlerts');
...
Route::resource('/sustainability/palm-oil-policy', 'SustainabilityController@front_sust_palm_oil');
Route::get('/sustainability/protection-biological-policy', 'SustainabilityController@front_sust_protection_biological');
Route::resource('/sustainability/protection-biological-policy', 'SustainabilityController@front_sust_protection_biological');
Route::get('/sustainability/equality-gender-policy', 'SustainabilityController@front_sust_equality_gender');
Route::resource('/sustainability/equality-gender-policy', 'SustainabilityController@front_sust_equality_gender');
Route::get('/sustainability/food-safety-policy', 'SustainabilityController@front_sust_food_safety');
Route::resource('/sustainability/food-safety-policy', 'SustainabilityController@front_sust_food_safety');
Route::get('/sustainability/quality-policy', 'SustainabilityController@front_sust_quality');
Route::resource('/sustainability/quality-policy', 'SustainabilityController@front_sust_quality');
Route::get('/sustainability/safety-health-policy', 'SustainabilityController@front_sust_safety_health');
Route::resource('/sustainability/safety-health-policy', 'SustainabilityController@front_sust_safety_health');
Route::get('/sustainability/safety-policy', 'SustainabilityController@front_sust_safety');
Route::resource('/sustainability/safety-policy', 'SustainabilityController@front_sust_safety');
Route::get('/sustainability/slope-river-protection-policy', 'SustainabilityController@front_sust_slop_river');
Route::resource('/sustainability/slope-river-protection-policy', 'SustainabilityController@front_sust_slop_river');
Route::get('/sustainability/certification-policy', 'SustainabilityController@front_sust_certification');
Route::resource('/sustainability/certification-policy', 'SustainabilityController@front_sust_certification');
Route::get('/sustainability/social-policy', 'SustainabilityController@front_sust_social');
Route::resource('/sustainability/social-policy', 'SustainabilityController@front_sust_social');
Route::resource('/sustainability/tor-board-nomination-committee', 'SustainabilityController@front_tor_board_nomination');
Route::resource('/sustainability/tor-audit-management-committee', 'SustainabilityController@front_tor_audit_management');
Route::resource('/sustainability/tor-risk-management-committee', 'SustainabilityController@front_tor_risk_management');
...
Route::get('investorrelations/newscentre/bursaannouncements/{announce_id?}', 'CorporateController@frontBursaAnnounceList');
...
Route::resource('investorrelations/reports/agm_egm_mswg', 'ReportsController@frontProspectusarReports');
...
Route::resource('investorrelations/managementanalysis/board_charter', 'CorporateController@frontManagementReviewOperations');
Route::resource('investorrelations/managementanalysis/whistleblower', 'CorporateController@frontManagementChairmansStat');
...
Route::resource('investorrelations/financialinformation/b_nominationcommittee', 'CorporateController@frontFinancialFlowStatements');
Route::resource('investorrelations/financialinformation/antibribery_anticorruption', 'CorporateController@frontFinancialEquity');
Route::resource('investorrelations/managementanalysis/directorsfitandproperpolicy', 'CorporateController@frontDirectorsFitAndProperPolicy');
Route::get('admin/directorsfitandproperpolicy', 'CorporateController@DirectorsFitAndProperPolicy');
...
Route::resource('investorrelations/financialinformation/b_remuneration_mgtcommittee', 'CorporateController@BoardRemunationCommittee');
Route::resource('investorrelations/financialinformation/b_risk_mgtcommittee', 'CorporateController@RiskManagementCommittee');
...
Route::get('investorrelations/riskcommittee', 'IpoController@riskcommittee');
Route::get('investorrelations/riskcommitteedetail/{announce_id}', 'IpoController@riskcommitteedetail');
...
Route::get('investorrelations/frontdocumentsubmissiondetail/{id}', 'IpoController@frontdocumentsubmissiondetail');
...
Route::get('investorrelations/ipocentre/estate_profile', 'IpoController@frontIpoCompetitiveAdvantage');
Route::get('investorrelations/ipocentre/estate_location', 'IpoController@frontIpoStatistics');
Route::resource('investorrelations/corporategovernance', 'CorporateController@frontCorpGovernance');
Route::resource('investorrelations/corporateinformation/tor-remuneration-committee', 'CorporateController@frontOurSubsidiaries');
Route::resource('investorrelations/corporateinformation/b_audit_mgtcommittee', 'CorporateController@frontOurProperties');
...
Route::post('admin/addfinancialsegment', 'CorporateController@AddFinancialInfoSegment');
Route::post('admin/editfinancialsegment', 'CorporateController@EditFinancialInfoSegment');
Route::post('admin/deleteallfinancialsegment', 'CorporateController@DeleteAllFinancialInfoSegment');
Route::post('admin/singledeletefinancialsegment', 'CorporateController@SingleDeleteFinancialInfoSegment');
Route::post('admin/deletemultiplefinancialInfo', 'CorporateController@DeleteMultipleFinancialInfo');