...
//-->
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2>Changes in Director's Interest (Section 219 of CA 2016) <i class="fa fa-angle-right"></i> Listing</h2>
			 ...
			 {{ Form::close()}} 
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Changes in Director's Interest (Section 219 of CA 2016) Listing</div>
                  <br/>
