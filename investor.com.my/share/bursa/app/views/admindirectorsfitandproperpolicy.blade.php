...
<script type="text/javascript" src="{{ URL::asset('js/modalPopup.js') }}"></script>
  ...
  <!--<div class="page-content">-->
          <div class="row">
            <div class="col-lg-12">
              <h2>Directors Fit and Proper Policy <i class="fa fa-angle-right"></i> Listing</h2>
              <div class="clearfix"></div>
                         
              <div class="pull-left"> Last updated: @if(!empty($page)) <span class="text-blue">{{ date("d F Y",strtotime($page[0]['updated_at'])) }} @ {{ date("g:i A",strtotime($page[0]['updated_at'])) }}</span> @endif </div>
              <div class="clearfix"></div>
              <p></p>
              {{ Form::open(array('url' => 'admin/page/savepage','class'=> 'form-horizontal','method' => 'post','name' => 'corporatdirprofile','id' => 'corporatdirprofile')) }} 
		   {{Form::hidden('preview','')}}
       @if(!empty($page))  {{Form::hidden('pageid',$page[0]['id'])}}
			  ...
			  <div class="portlet">
                ...
                <div class="portlet-body">
                  <div contenteditable="true" id="page-title">
                    @if(!empty($page))   {{$page[0]['page_title']}} @endif
                  </div>
                  @if(!empty($page)) {{ Form::textarea('page_title',$page[0]['page_title'],array("id" => "textarea-page-title","class" => "hideThisField")) }} @endif
                </div>
              </div>
              <div class="portlet">
                <div class="portlet-header">
                ...
                <div class="portlet-body">
                 <div contenteditable="true" id="left-block1-title">
                  @if(!empty($page))  {{ $page[0]['left_block1_title'] }} @endif
                 </div>
                 @if(!empty($page))   {{ Form::textarea('left_block1_title',$page[0]['left_block1_title'],array("id" => "textarea-left-block1-title","class" => "hideThisField")) }} @endif
                </div>
              </div>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          {{ Form::open(array('url' => 'admin/oursubsidiariesadd','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                              ...
                              {{Form::hidden('type','directorsfitandproperpolicy')}}
