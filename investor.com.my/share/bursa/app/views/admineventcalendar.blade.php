...
@section('content')
   <!--<div class="page-content">-->
          <div class="row">
            <div class="col-lg-12">
              <h2>Event Calendar <i class="fa fa-angle-right"></i> Listing</h2>
...
<div class="form-actions none-bg"> <a href="javascript:void(0);" class="btn btn-red" onclick="Addsavepage('corporatdirprofile','');">Save &amp; Preview &nbsp;<i class="fa fa-search"></i></a>&nbsp; <button type="submit" class="btn btn-blue">Save &amp; Publish &nbsp;<i class="fa fa-globe"></i></button>&nbsp; <a href="#" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
			 {{ Form::close()}} 
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Events Listing</div>
                  <br/>
                  ...
                  <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu">
                      <li><a href="#" data-target="#modal-delete-selected-process" data-toggle="modal" class="deleteid" rel="{{url();}}/admin/eventmultipledelete" rev="modal-delete-selected-process">Delete selected item(s)</a></li>
                      <li class="divider"></li>
                    ...
                    <div class="modal-dialog modal-wide-width">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 id="modal-login-label2" class="modal-title">Add New Event</h4>
                        </div>
                        <div class="modal-body">
                          <div class="form">
                          {{ Form::open(array('url' => 'admin/eventadd','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  {{ Form::text('title','',array('id' => 'title','class' => 'form-control', 'placeholder' => 'Event Title' )) }} 
                                </div>
                              </div>
                              <div class="form-group">
							  ...
							  <div class="form-group">
                                <label class="col-md-3 control-label">Event Time <span class='require'>*</span></label>
                                <div class="col-md-5">
                                  <div class="input-group bootstrap-timepicker">
								  {{Form::text('time','',array('id'=>'time','class' => 'timepicker-default form-control', 'placeholder' => 'HH:MM'))}}  
                                   
                                    <span class="input-group-addon"><i class="fa fa-clock-o"></i></span> </div>
                                </div>
                              </div>
							  <div class="form-group">
                                <label class="col-md-3 control-label">Event Venue <span class='require'>*</span></label>
                                <div class="col-md-9">
                                {{ Form::textarea('venue','',array("id" => "venue","class" => "form-control","rows"=>"2")) }} 
                                </div>
                              </div>
							  <div class="form-group">
				  ...
				  {{ Form::textarea('content','',array("id" => "textarea-contents","class" => "hideThisField","rows"=>"3")) }} 
                                </div>
                              </div>
	...
	{{ Form::select('noperpage2', $cntarray1, Input::get('noperpage2'),array('class' => 'form-control','onchange' => 'this.form.submit();')) }}
	 {{ Form::close() }}
                            ...
                            <div id="modal-edit-director{{$slidingbanner->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog modal-wide-width">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                    <h4 id="modal-login-label2" class="modal-title">Edit Event</h4>
                                  </div>
                                  <div class="modal-body">
                                    <div class="form">
                                  {{ Form::open(array('url' => 'admin/eventedit','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                                        <div class="form-group">
                                          <label class="col-md-3 control-label">Status</label>
                                          <div class="col-md-9">
                                            <div data-on="success" data-off="primary" class="make-switch">
							  ...
							  <div class="form-group">
                                ...
                                <div class="col-md-5">
                                  <div class="input-group bootstrap-timepicker">
								  {{Form::text('time',$slidingbanner->time,array('id'=>'time','class' => 'timepicker-default form-control', 'placeholder' => 'HH:MM'))}}  
							  ...
							  <div class="form-group">
                                <label class="col-md-3 control-label">Event Venue <span class='require'>*</span></label>
                                <div class="col-md-9">
                                {{ Form::textarea('venue',$slidingbanner->venue,array("id" => "venue","class" => "form-control","rows"=>"2")) }} 
                                </div>
                              </div>
							  <div class="form-group">
                                <label for="inputContent" class="col-md-3 control-label">Event Content</label>
				  ...
				  {{ Form::textarea('content',$slidingbanner->content,array("id" => "textarea-content".$slidingbanner->id,"class" => "hideThisField","rows"=>"3")) }} 
                                </div>
                              </div>
                            ...
                            <div id="modal-delete-dir{{$slidingbanner->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                    <h4 id="modal-login-label3" class="modal-title"><a href=""><i class="fa fa-exclamation-triangle"></i></a> Are you sure you want to delete this event? </h4>
                                  </div>
                                  <div class="modal-body">
                                    <p><strong>#{{$slidingbanner->id}}:</strong> {{$slidingbanner->title}}</p>
                                    <div class="form-actions">
                                      <div class="col-md-offset-4 col-md-8">  {{ Form::open(array('url' => 'admin/eventsingledelete', 'method' => 'post', 'name' => 'delete'.$slidingbanner->id, 'id' => 'delete'.$slidingbanner->id, 'class' => 'form-horizontal','files' => true)) }}
