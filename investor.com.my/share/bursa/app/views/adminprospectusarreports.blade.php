              ...
              <div class="portlet">
                <div class="portlet-header">
				  ...
				  {{ Form::textarea('content','',array("id" => "textarea-content","class" => "hideThisField")) }} 
                              ...
                              <div class="form-group">
                               <label class="col-md-3 control-label">Upload AGM (PDF)</label>
                                <div class="col-md-8">
                                  <div class="text-15px margin-top-10px">
							    ...
							    <div class="form-group">
                               <label class="col-md-3 control-label">Upload EGM (PDF)</label>
                                <div class="col-md-8">
                                  <div class="text-15px margin-top-10px">
							 ...
							 <div class="form-group">
                               <label class="col-md-3 control-label">Upload Supplementary Notice Of AGM (PDF)</label>
...
{{ Form::file('image',array('id' => 'image')) }}        
										...
										<div class="form-group">
                                          <label for="inputContent" class="col-md-3 control-label">Upload AGM (PDF)</label>
