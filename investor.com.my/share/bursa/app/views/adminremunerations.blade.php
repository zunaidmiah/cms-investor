...
@section('content')
  <!--<div class="page-content">-->
          <div class="row">
            <div class="col-lg-12">
              <h2>Remunerations Committee <i class="fa fa-angle-right"></i> Listing</h2>
...
<div class="form-actions none-bg"> <a href="javascript:void(0);" class="btn btn-red" onclick="Addsavepage('corporatdirprofile','');">Save &amp; Preview &nbsp;<i class="fa fa-search"></i></a>&nbsp; <button type="submit" class="btn btn-blue">Save &amp; Publish &nbsp;<i class="fa fa-globe"></i></button>&nbsp; <a href="#" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                ...
                <div class="portlet-header">
                  ...
                  <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu">
                      <li><a href="#" data-target="" data-toggle="modal" class="deleteid" rel="{{url('admin/remunerationsdeletemultiple')}}" rev="modal-delete-selected-process">Delete selected item(s)</a></li>
                      <li class="divider"></li>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="form">
                          {{ Form::open(array('url' => 'admin/remunerationsadd','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                              ...
                              {{Form::hidden('type','remunerations')}}
  ...
  {{ Form::select('noperpage1', $cntarray1, Input::get('noperpage1'),array('class' => 'form-control','onchange' => 'this.form.submit();')) }}
   {{ Form::close() }}
                  ...
                  <br/>
                  <br/>
                  <table class="table table-hover table-striped t-list">
                    <thead>
                      <tr>
 ...
 <!-- Remuneration Page JS -->
  <script type="text/javascript">
   ...
   if($(this).is(':checked'))
   {
      ...
      $(a).attr('data-target','#modal-delete-selected-process');
