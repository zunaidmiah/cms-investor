...
@section('content')
  <!--<div class="page-content">-->
          <div class="row">
            <div class="col-lg-12">
              <h2>Risk Management Committee <i class="fa fa-angle-right"></i> Listing</h2>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="form">
                          {{ Form::open(array('url' => 'admin/riskmanagementadd','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                              ...
                              {{Form::hidden('type','risk_management')}}
