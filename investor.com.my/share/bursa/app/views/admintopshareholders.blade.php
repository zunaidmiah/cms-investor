...
<script type="text/javascript" src="{{ URL::asset('js/modalPopup.js') }}"></script>
  ...
  <!--<div class="page-content">-->
          <div class="row">
            <div class="col-lg-12">
              <h2>Shareholders <i class="fa fa-angle-right"></i> Edit</h2>
...
<div class="form-actions none-bg"> <a href="javascript:void(0);" class="btn btn-red" onclick="Addsavepage('corporatdirprofile','');">Save &amp; Preview &nbsp;<i class="fa fa-search"></i></a>&nbsp; <button type="submit" class="btn btn-blue">Save &amp; Publish &nbsp;<i class="fa fa-globe"></i></button>&nbsp; <a href="#" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
			 {{ Form::close()}} 
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Shareholders Listing</div>
                  <br/>
                    ...
                    <div class="modal-dialog  ">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 id="modal-login-label2" class="modal-title">Add New Shareholder</h4>
                        </div>
                        <div class="modal-body">
                          <div class="form">
                          {{ Form::open(array('url' => 'admin/addtopshareholders','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                              ...
                              <div class="form-group">
							   ...
							   <div class="form-group">
                                                            <label class="col-md-4 control-label"># of Shares Held <span class='require'>*</span></label>
                                                            <div class="col-md-8">
                                                               {{ Form::text('shareheld','',array('id' => 'shareheld','class' => 'form-control', 'placeholder' => '' )) }} 
                                                            </div>
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label class="col-md-4 control-label">% <span class='require'>*</span></label>
                                                            <div class="col-md-5">
                                                             {{ Form::text('shareheld2','',array('id' => 'shareheld2','class' => 'form-control', 'placeholder' => '' )) }} 
                                                            </div>
                                                        </div>
                              <div class="form-group">
                  ...
                  <div id="modal-delete-selected-process" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                        <div class="form-actions">
                              {{ Form::open(array('url' => 'admin/page/pdfdeletemultiple', 'method' => 'post', 'name' => 'deletemultiple', 'id' => 'deletemultiple', 'class' => 'form-horizontal','onsubmit' => 'getAllChecked();')) }} 
                    ...
                    <tbody>
					 @foreach ($profilelist as $k => $slidingbanner)   
                      <tr>
                        ...
                        <td> {{ $slidingbanner->shareheld }}</td>
						   <td> {{ $slidingbanner->shareheld2 }}</td>
                            ...
                            <div id="modal-edit-director{{$slidingbanner->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                    <h4 id="modal-login-label2" class="modal-title">Edit Shareholder</h4>
                                  </div>
                                  <div class="modal-body">
                                    <div class="form">
                                  {{ Form::open(array('url' => 'admin/edittopshareholders','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                                        <div class="form-group">
                                          <label class="col-md-4 control-label">Status</label>
                                          <div class="col-md-8">
                                            <div data-on="success" data-off="primary" class="make-switch">
                                        ...
                                        <div class="form-group">
                                          <label class="col-md-4 control-label">Name <span class='require'>*</span></label>
                                          <div class="col-md-8"> {{ Form::textarea('name',$slidingbanner->name, array('id' => 'name','class' => 'form-control', 'rows' => '2')) }}
                                          </div>
                                        </div>
										 <div class="form-group">
                                                            <label class="col-md-4 control-label"># of Shares Held <span class='require'>*</span></label>
                                                            <div class="col-md-8">
                                                               {{ Form::text('shareheld',$slidingbanner->shareheld,array('id' => 'shareheld','class' => 'form-control', 'placeholder' => '' )) }} 
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-4 control-label">% <span class='require'>*</span></label>
                                                            <div class="col-md-5">
                                                             {{ Form::text('shareheld2',$slidingbanner->shareheld2,array('id' => 'shareheld2','class' => 'form-control', 'placeholder' => '' )) }} 
                                                            </div>
                                                        </div>
                                        <div class="form-group">
                                          <label class="col-md-4 control-label">Date <span class='require'>*</span></label>
                            ...
                            <div id="modal-delete-dir{{$slidingbanner->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                    <h4 id="modal-login-label3" class="modal-title"><a href=""><i class="fa fa-exclamation-triangle"></i></a> Are you sure you want to delete this shareholder? </h4>
                                  </div>
                                  <div class="modal-body">
                                    <p><strong>#{{$slidingbanner->id}}:</strong> {{$slidingbanner->name}}</p>
                                    <div class="form-actions">
                                      <div class="col-md-offset-4 col-md-8">  {{ Form::open(array('url' => 'admin/singledeletetopshareholders', 'method' => 'post', 'name' => 'delete'.$slidingbanner->id, 'id' => 'delete'.$slidingbanner->id, 'class' => 'form-horizontal','files' => true)) }}
