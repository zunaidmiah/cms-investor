          ...
          <div class="row">
            <div class="col-lg-12">
			 ...
			 {{ Form::close()}} 
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Notice of Resale/Cancellation of Treasury Share - Immediate Announcements Listing</div>
                  <br/>
                            ...
                            <div id="modal-delete-{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                    <h4 id="modal-login-label3" class="modal-title"><a href=""><i class="fa fa-exclamation-triangle"></i></a> Are you sure you want to delete announcement? </h4>
                                  </div>
                                  <div class="modal-body">
