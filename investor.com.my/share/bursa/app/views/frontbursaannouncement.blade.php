          ...
          <div class="info_white1 border_bottom">
            <div class="container">
              ...
              <div class="pull-right margin_top_10px">
				<!--<a class="button" href="{{ URL::to('investorrelations/newscentre/bursaannouncements') }}">Back</a>-->
              	<!--<a class="button" href="http://bursa.fareastholdingsbhd.com/investorrelations/newscentre/bursaannouncements">Back</a>-->
              </div>
