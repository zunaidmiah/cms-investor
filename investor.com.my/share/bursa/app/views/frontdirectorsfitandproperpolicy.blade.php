...
@section('content')
   ...
   <!-- Info white-->
          ...
          <div class="info_white1 border_bottom">
            <div class="container">
              {{ !empty($page)?$page[0]['left_block1_title']:"" }}	
              <!--<h2 class="red-title">{{ !empty($page)?$page[0]['page_title']:"" }}</h2>-->
                ...
                <div class="span12">
                	<div id="twitter-bootstrap-container">
                        <div id="twitter-bootstrap-tabs">
                             ...
                             @if($k == 0)
                             {{ Form::open(array('url' => '/investorrelations/managementanalysis/directorsfitandproperpolicy','method' => 'post','name' => 'directorsfitandproperpolicy', 'id' => 'directorsfitandproperpolicy' )) }}       
