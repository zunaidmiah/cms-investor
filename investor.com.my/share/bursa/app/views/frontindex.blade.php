              ...
              <div class="row-fluid animated fadeInUp delay2">
                ...
                <div class="span3 pull-left">
                 ...
                 <div class="span3 pull-left">
                       ...
                       <?php
                                if(($stockdata->close - $laststockdata->close) < 0)
                                {
                ...
                <div class="span6">
                	<div class="row-fluid animated fadeInUp delay4">
                      ...
                      <div align="left">
                       ...
                       <blockquote>
                            <div class="label label-info">{{ date("d M, Y",$latest->date) }}</div> <a href="https://medianews.fareastholdingsbhd.com/news/news_centre_latest_media_news_details?show={{ $latest->id }}" target="_blank">{{ $latest->title }}</a>
