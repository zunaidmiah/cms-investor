                    ...
                    @if( isset($announcements) && count($announcements) > 0 )
                        ...
                        @foreach( $announcements as $announcement )
                            <tr>
                                ...
                                <td><a href="/investorrelations/frontlistingcirculardetail/{{ $announcement->id }}">{{ $announcement->title }}</a></td>
                            </tr>
                        @endforeach
                    @endif
                      ...
                      {{--<tr>--}}
                         ...
                         {{--<td><a href="news_centre_bursa_listing_circulars_details_20141113.html">OCK - NOTICE OF BONUS ENTITLEMENT</a></td>--}}
                      {{--</tr>--}}
                      {{--<!--<tr>--}}
                         {{--<td>1</td>--}}
                         {{--<td>03 May 2013</td>--}}
                         {{--<td>FAR EAST HOLDINGS BERHAD</td>--}}
                         {{--<td><a href="news_centre_bursa_listing_circulars_details.html">OCK - NOTICE OF BOOK CLOSURE</a></td>--}}
                      {{--</tr>--}}
                      {{--<tr>--}}
                         {{--<td>2</td>--}}
                         {{--<td>21 Sep 2012</td>--}}
                         {{--<td>FAR EAST HOLDINGS BERHAD</td>--}}
                         {{--<td><a href="#">OCK - NOTICE OF BOOK CLOSURE</a></td>--}}
                      {{--</tr>-->--}}
