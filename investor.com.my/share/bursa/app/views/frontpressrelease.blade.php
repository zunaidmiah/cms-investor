							...
							<div class="widget-content">
								<div class="list list-style__check">
									<ul>
                                        ...
                                        <li><a href="{{url()}}/investorrelations/pressreleasesort/{{ $category->year }}">{{ $category->year }}</a> ({{ $category->count }})</li>
                                        @endforeach
							...
							<div class="widget-content">
								<ul class="thumbs-list thumbs-list__clean">
									...
									{{ $page->left_inner_block_title14 }}
									 ...
									 {{ $page->left_inner_block_content14 }} 
								...
								<a href="{{ url() }}/investorrelations/pressrelease" class="button"><span class="button-inner">View All</span></a>
							</div>
						</div>
						<!-- /Recent Posts Widget -->
					</aside>
