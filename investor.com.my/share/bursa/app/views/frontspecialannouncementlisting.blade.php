                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        @if( isset($announcements) && count($announcements) > 0 )
                            ...
                            @foreach($announcements as $announcement)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/investorrelations/frontspecialannouncementdetail/{{ $announcement->id }}">
                                            {{ $announcement->title }}
                                        </a>
                                    </td>
                                </tr>
                      ...
                      <!--<tr>
                         ...
                         <td><a href="news_centre_bursa_special_announcements_details.html">Timetable for IPO</a></td>
                      </tr>-->
