...
<div class="crumbs border_bottom">				
        ...
        <!-- End crumbs-->   
          ...
          <div class="row message-area" style="margin-top: 20px">
            <div class="span1">
			</div>
            <div class="span12">
                ...
                <div class="container">
                    <div class="row-fluid">
                        <div class="span12">
                             ...
                             <h5>Far East Holdings Berhad 197301001753 (14809-W)<br/>Sustainability Department<br/>Level 23, Menara Zenith, Jalan Putra Square 6, 25200 Kuantan, Pahang Darul Makmur, Malaysia</h5>
<ul class="unstyled">
            ...
            <li><span class="label label-warning">Fax:</span> +(609) 513-6211</li>
                                <li><span class="label label-success">E-mail:</span> <a href="mailto:sustainability@fareh.po.my">sustainability@fareh.po.my</a></li>
                             </ul>
                      </div>
        ...
        m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
           ...
           $("form").submit(function(event) {
            ...
            if (recaptcha === "") {
              ...
              alert("Unable to Submit Form, Please check the Recaptcha!");
            }
          });
