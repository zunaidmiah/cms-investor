   ...
   {{Form::password('confirmpassword', array('id'=>'confirmpassword','class' => 'validate[required,equals[password1]] form-control'))}} 
      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
         <?php
            ...
            <li>Investor Relations &nbsp;<i class="fa fa-angle-right"></i>&nbsp;</li>
            <li>Corporate Information &nbsp;<i class="fa fa-angle-right"></i>&nbsp;</li>
            <li class="active">Audit and Risk Management Committee - Listing</li>';
               $title  = "Corporate Information";
...
Users - Listing</li>';
           ...
           <li class="active">Slop & River Protection Policy - Listing</li>';
                $title  = "Sustainability";
           ...
           <li class="active">Terms of Reference - Audit Management Committee - Listing</li>';
                $title  = "Governance";
           ...
           <li class="active">Terms of Reference - Board Nomination Committee - Listing</li>';
                $title  = "Governance";
