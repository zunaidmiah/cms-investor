...
$source = mysql_connect('localhost', 'fareasth_bursa', '1410Qf-9Hv.SH(g') or die("Can't connect user 'fareasth_bursa' from source DB. MySQL Says:".  mysql_error());
$dest = mysql_connect('localhost', 'fareasth_bursa', '1410Qf-9Hv.SH(g',true) or die("Can't connect user 'fareasth_bursa' from source DB. MySQL Says:".  mysql_error());

mysql_select_db('fareasth_yahoo', $source) or die("Can't Select source DB. MySQL Says:".  mysql_error());
mysql_select_db('fareasth_bursa', $dest) or die("Can't Select dest., DB. MySQL Says:".  mysql_error());
