...
$('.updateOrder').click(function() {
   ...
   $('.display_order').each(function () {
          ...
          $.ajax({
                   type: "POST",
                   url: "/~yeelee72185perak/laravel/public/admin/updateorder",
    ...
    $('.updateOrder1').click(function() {
    $('.updateOrder1 i').addClass('fa-spin');
   var Model = $('#updateOrder1mname').val();
   var serData = '{';
   $('.display_order1').each(function () {
          ...
          $.ajax({
				  ...
				  data: { OrderData: jsonPost , model:Model},
				  success: function(data){
                                      $('.updateOrder1 i').removeClass('fa-spin');
                                      },
				  failure: function(errMsg) {
...
$('.highlights-status').on("change",function(){
