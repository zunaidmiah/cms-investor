...
class StockController extends BaseController {
    ...
    public function PriceTicker() {
        ...
        return View::make('adminpriceticker', array(
                    'page' => $page,
                    'stockdata' => $stockdata,
...
//        );
    ...
    public function Shareholding() {
        ...
        return View::make('adminshareholding', array(
                    'page' => $page
                        )
        );
    }
    ...
    public function ShareholdersList() {
        ...
        return View::make('adminshareholderslist', array(
                    'page' => $page,
    ...
    public function TopShareholders() {
        ...
        return View::make('admintopshareholders', array(
                    'page' => $page,
                    'profilelist' => $Profileslisting,
                    'cntarray1' => $cntarray1
                        )
    ...
    public function frontPriceTicker() {
        ...
        return View::make('frontpriceticker', array(
                    'page' => $page,
                    'pageTitle' => $pageTitle,
                    'masthead' => $masthead,
                    'breadcrumbs' => $breadcrumbs,
...
//print_r("select date_format(date, '%d/%m/%Y') as `date1`,high as PriceHigh, DATEDIFF(NOW(), date) as `nodays` FROM ohlcvs $yWhere ORDER BY high DESC limit 0,1"); exit;
        ...
        return View::make('frontpriceandvolume', array(
                    'page' => $page,
                    'pageTitle' => $pageTitle,
                    'masthead' => $masthead,
                    'breadcrumbs' => $breadcrumbs,
    ...
    public function frontShareholding() {
        ...
        return View::make('frontshareholding', array(
                    'page' => $page,
                    'pageTitle' => $pageTitle,
                    'masthead' => $masthead,
                    'breadcrumbs' => $breadcrumbs,
    ...
    public function frontTopShareholders() {
        ...
        $mainMenuTitle = $page[0]->page_title;
        $metaTitle = $mainMenuTitle;
        return View::make('fronttopshareholders', array(
                    'page' => $page,
                    'shares' => $shares,
                    'dateSorts' => $dateSorts,
                    'pageTitle' => $pageTitle,
