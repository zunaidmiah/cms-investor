...
function scrapMediaNews() {
    ...
    get_curl_data('http://medianews.ock.net.my/webscraper/grabAllDataCron');
    //Write log OR in Database
}

function sendMail() {
    get_curl_data('http://medianews.ock.net.my/webscraper/sendMail');
}

function sendTestMail() {
    get_curl_data('http://medianews.ock.net.my/webscraper/sendTestMail');
}
