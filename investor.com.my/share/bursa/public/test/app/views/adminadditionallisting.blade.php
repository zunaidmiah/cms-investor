...
@section('content')
 <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2>Additional Listing Announcement <i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Additional Listing Announcements Listing</div>
                  <br/>
                  ...
                  <div id="modal-add-announcement" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog modal-wide-width">
					  ...
					  {{ Form::open(array('url' => 'admin/inverstoralert/saveAdditional','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                        ...
                        <div class="modal-body">
                          <div class="form">
                            <form class="form-horizontal">
                              ...
                              {{Form::hidden('type','Additional Listing')}}
                ...
                <div class="portlet-body">
                  ...
                  <table class="table table-hover table-striped">
                    ...
                    <tbody>
                      <?php
					 $i=1;
					 // print_r($adminadditionallisting);
					 // die;
                            ...
                            <div id="modal-delete-{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                    <h4 id="modal-login-label3" class="modal-title"><a href=""><i class="fa fa-exclamation-triangle"></i></a> Are you sure you want to delete Additional Listing? </h4>
                                  </div>
                                  <div class="modal-body">
