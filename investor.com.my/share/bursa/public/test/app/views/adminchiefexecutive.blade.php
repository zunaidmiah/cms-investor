...
@section('content')
      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2>Change in Chief Executive Officer <i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                 ...
                 <div class="portlet-body">
                    <div contenteditable="true">
                       <h2 class="red-title pull-left"><span>Change in Chief Executive Officer</span></h2>
                       <div class="clearfix"></div> 
                    </div>              
                 </div>
                 <!-- end portlet body -->
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Change in Chief Executive Officer Announcements Listing</div>
                  <br/>
                  ...
                  <table class="table table-hover table-striped">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Change in Chief Executive Officer</td>
                                      ...
                                      <div class="form">
                                        <form class="form-horizontal">
                                          ...
                                          <div class="form-group">
                                            <label class="col-md-3 control-label">Title <span class='require'>*</span></label>
                                            <div class="col-md-6">
                                              <textarea name="inputContent" rows="2" class="form-control" id="inputContent">Change in Chief Executive Officer</textarea>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-md-3 control-label">Announcement Date <span class='require'>*</span></label>
                                              ...
                                              <div class="info_resalt border_bottom">
                                                  <div class="row-fluid">
                                                    <div class="col-lg-12">
                                                      ...
                                                      <div contenteditable="true">
                                                          <div class="alert alert-error">
                                                              <strong>Reference No:</strong> sample text   
                                                          </div>
                                                      </div>
                                                    </div>      
                                                  </div>
