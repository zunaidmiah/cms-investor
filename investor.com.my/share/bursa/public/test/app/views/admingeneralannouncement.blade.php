...
@section('content')
      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2>General Announcement <i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">General Announcement Announcements Listing</div>
                  <br/>
                 ...
                 <div id="modal-add-announcement" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog modal-wide-width">
					  ...
					  {{ Form::open(array('url' => 'admin/inverstoralert/saveGeneralAnnouncement','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                        ...
                        <div class="modal-body">
                          <div class="form">
                            <form class="form-horizontal">
                              ...
                              {{Form::hidden('type','General Announcement')}}
