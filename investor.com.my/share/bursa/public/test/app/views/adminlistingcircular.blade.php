...
@section('content')
      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2>Listing Circulars <i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Listing Circulars Announcements Listing</div>
                  <br/>
                        ...
                        <div class="modal-body">
                          <div class="form">
                            <form class="form-horizontal">
                              ...
                              {{Form::hidden('type','Listing Circular')}}
