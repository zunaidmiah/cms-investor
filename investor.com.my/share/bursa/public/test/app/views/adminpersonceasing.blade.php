...
<title>Notice of Person Ceasing (29C):: Listing</title>
<!-- InstanceEndEditable -->
<meta charset="utf-8">
...
<!--BEGIN TO TOP--><a id="totop" href="#"><i class="fa fa-angle-up"></i></a><!--END BACK TO TOP-->
  <div id="wrapper"><!--BEGIN TOPBAR-->
      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2>Notice of Person Ceasing (29C) <i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                 ...
                 <div class="portlet-body">
                    <div contenteditable="true">
                       <h2 class="red-title pull-left"><span>Notice of Person Ceasing (29C)</span></h2>
                       <div class="clearfix"></div> 
                    </div>              
                 </div>
                 <!-- end portlet body -->
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Notice of Person Ceasing (29C) Announcements Listing</div>
                  <br/>
                                   ...
                                   <div class="table-responsive">
                                       <div contenteditable="true">
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                <td><strong>Number of securities disposed</strong></td>
                                                <td>Please fill in content</td>
                                              </tr>
                                              <tr>
                                              ...
                                              <tr>
                                                <td><strong>Circumstances by reason of which a person ceases to be a substantial securities Holder</strong></td>
                                                <td>Please fill in content</td>
                                              </tr>
                                              <tr>
                  ...
                  <div id="modal-delete-selected" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p><strong>#1:</strong> 25 June, 2014 - Announcement Title</p>
                          <div class="form-actions">
                                      ...
                                      <div class="form">
                                        <form class="form-horizontal">
                                          ...
                                          <div class="form-group">
                                            <label class="col-md-3 control-label">Title <span class='require'>*</span></label>
                                            <div class="col-md-6">
                                              <textarea name="inputContent" rows="2" class="form-control" id="inputContent">Announcement Title</textarea>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-md-3 control-label">Announcement Date <span class='require'>*</span></label>
