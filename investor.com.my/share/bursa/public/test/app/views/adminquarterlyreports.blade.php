...
@section('content')
  <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Quarterly Reports<i class="fa fa-angle-right"></i> Listing</h2>
...
<div class="form-actions none-bg"> <a href="javascript:void(0);" class="btn btn-red" onclick="Addsavepage('corporatdirprofile','');">Save &amp; Preview &nbsp;<i class="fa fa-search"></i></a>&nbsp; <button type="submit" class="btn btn-blue">Save &amp; Publish &nbsp;<i class="fa fa-globe"></i></button>&nbsp; <a href="#" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
			 {{ Form::close()}} 
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Quarterly Reports Listing</div>
                  <br/>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 id="modal-login-label2" class="modal-title">Add PDF</h4>
                        </div>
                        <div class="modal-body">
                          ...
                          {{ Form::open(array('url' => 'admin/add','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                              ...
                              <div class="form-group">
                               <label class="col-md-3 control-label">Upload 1st Quarter Report </label>
                                <div class="col-md-8">
                                  <div class="text-15px margin-top-10px">
							  ...
							  <div class="form-group">
                                <label class="col-md-3 control-label">Upload 2nd Quarter Report </label>
                                <div class="col-md-9">
                                  <div class="text-15px margin-top-10px">
							   ...
							   <div class="form-group">
                                <label class="col-md-3 control-label">Upload 3rd Quarter Report </label>
                                <div class="col-md-9">
                                  <div class="text-15px margin-top-10px">
                              ...
                              <div class="form-group">
                                <label class="col-md-3 control-label">Upload 4th Quarter Report </label>
                                <div class="col-md-9">
                                  <div class="text-15px margin-top-10px">
                              ...
                              {{Form::hidden('type','quarterlyreports')}}
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  {{ Form::open(array('url' => 'admin/edit','class'=> 'form-horizontal','method' => 'post','files' => true)) }}
                                        ...
                                        <div class="form-group">
                                          <label class="col-md-4 control-label">Upload Image Cover </label>
                                          <div class="col-md-8">
                                            <div class="text-15px margin-top-10px"> 
...
{{ Form::file('image',array('id' => 'image')) }}        
										...
										<div class="form-group">
                                          <label for="inputContent" class="col-md-3 control-label">Upload 1st Quarter Report</label>
                                    ...
                                    {{ Form::hidden('id',$slidingbanner->id) }}       
										...
										<div class="form-group">
                                          <label for="inputContent" class="col-md-3 control-label">Upload 2nd Quarter Report</label>
                                          <a href="{{$slidingbanner->pdf2->url()}}" target="_blank">{{$slidingbanner->pdf2_file_name}}</a><br />
                                          <div class="col-md-9">
                                             {{Form::file('pdf2', null,array('id'=>'pdf2Input'))}}
                                          
                                            <!-- end content editable-->
                                          </div>
                                        </div>
										<div class="form-group">
                                          <label for="inputContent" class="col-md-3 control-label">Upload 3rd Quarter Report</label>
                                          <a href="{{$slidingbanner->pdf->url()}}" target="_blank">{{$slidingbanner->pdf3_file_name}}</a><br />
                                          <div class="col-md-9">
                                             {{Form::file('pdf3', null,array('id'=>'pdf3Input'))}}
                                        
                                            <!-- end content editable-->
                                          </div>
                                        </div>
										<div class="form-group">
                                          <label for="inputContent" class="col-md-3 control-label">Upload 4th Quarter Report</label>
                                          <a href="{{$slidingbanner->pdf4->url()}}" target="_blank">{{$slidingbanner->pdf4_file_name}}</a><br />
                                          <div class="col-md-9">
                                             {{Form::file('pdf4', null,array('id'=>'pdf4Input'))}}
