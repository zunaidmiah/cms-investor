...
@section('content')
      ...
      <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2>Notice of Shares Buy Back by a Company Pursuant to Form 28B <i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                 ...
                 <div class="portlet-body">
                    <div contenteditable="true">
                       <h2 class="red-title pull-left"><span>Notice of Shares Buy Back by a Company Pursuant to Form 28B</span></h2>
                       <div class="clearfix"></div> 
                    </div>              
                 </div>
                 <!-- end portlet body -->
              ...
              <div class="portlet">
                <div class="portlet-header">
                  <div class="caption">Notice of Shares Buy Back by a Company Pursuant to Form 28B Announcements Listing</div>
                  <br/>
                  ...
                  <div id="modal-delete-selected" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p><strong>#1:</strong> 25 June, 2014 - Notice of Shares Buy Back by a Company pursuant to Form 28B</p>
                          <div class="form-actions">
                  ...
                  <table class="table table-hover table-striped">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Notice of Shares Buy Back by a Company pursuant to Form 28B</td>
                                      ...
                                      <div class="form">
                                        <form class="form-horizontal">
                                          ...
                                          <div class="form-group">
                                            <label class="col-md-3 control-label">Title <span class='require'>*</span></label>
                                            <div class="col-md-6">
                                              <textarea name="inputContent" rows="2" class="form-control" id="inputContent">Notice of Shares Buy Back by a Company pursuant to Form 28B </textarea>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-md-3 control-label">Announcement Date <span class='require'>*</span></label>
