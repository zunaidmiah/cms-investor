...
<div class="info_white1 border_bottom">
          ...
          if((!empty($TradingRight)) && (count($TradingRight)!=0)){
          foreach($TradingRight as $Trading){
          ?>
          <tr>
                        <td><?php echo $i;?></td>
                        <td><?php echo $Trading->date_of_publishing;?></td>
                        <td><?php echo $Trading->company_name;?></td>
                        <td><a href= "#" ><?php echo $Trading->title;?></td>
                      </tr>
          <?php
          $i++; 
          }
