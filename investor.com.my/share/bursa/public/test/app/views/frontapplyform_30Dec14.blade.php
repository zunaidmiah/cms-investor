...
@section('content')
  ...
  {{ Form::text('name','',array('id' => 'name','class' => 'validate[required]'))}}										<label for="name"><strong>Your Name</strong> <span class="text-red">(*required)</span></label>
   ...
   {{ Form::text('dob','DD / MM / YYYY',array('id' => 'dob'))}}
      ...
      {{ Form::radio('gender', 'f') }} Female
		...
		{{ Form::select('education', array('no' => '-- Please select --', 
                                    ...
                                    <div class="field">
		<label for="email"><strong>Cotnact No.</strong> <span class="text-red">(*required)</span></label>
		 {{ Form::text('contactno','',array('id' => 'contactno'))}}  
									</div>
									<div class="field">
		...
		{{ Form::file('resume','',array('id' => 'resume'))}}  
                                    ...
                                    <div class="field">
                {{ Form::checkbox('agree','',array('id' => 'agree'))}}   By clicking the "Submit" button,below, I agree to the terms stipulated in the service agreement & privacy policy. 
                                    </div>
                                    <div class="line"></div>
