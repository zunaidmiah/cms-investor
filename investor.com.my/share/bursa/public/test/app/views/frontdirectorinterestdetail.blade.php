...
@section('content')
 <div class="info_white1 border_bottom">
            <div class="container">
              <h2 class="red-title pull-left"><span>Changes in Director's Interest (S135) - Low Hock Keong</span></h2>
              ...
              <div class="row-fluid">
                <div class="span12">
                  ...
                  <p>Notes:
                  	<ul class="list icons">
                    	<li><i class="icon-ok"></i> * Deemed interested in his Mother, Hoh Moh Ying's direct shareholdings in OCK Group Berhad. </li>
