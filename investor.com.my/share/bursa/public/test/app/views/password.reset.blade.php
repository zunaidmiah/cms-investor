    ...
    {{ Form::open(array('url' => '/password/reset', 'method' => 'post')) }}
        ...
        <div class="form-group">
            <div class="input-icon"><i class="fa fa-user"></i>
                {{Form::text('password', null,array('class' => 'form-control','placeholder' => 'Your Email'))}}
                 </div>
      </div>
      
      <div class="form-group">
            <div class="input-icon"><i class="fa fa-user"></i>
                {{Form::text('password_confirmation', null,array('class' => 'form-control','placeholder' => 'Your Email'))}}
                 </div>
      </div>
       ...
       <div class="form-group">
            ...
            <a id="btn-forgot-pwd" href="login.html" class="mlm">Return to Login Page</a></div>
        <hr>
