...
(function () {
    ...
    (function () {
        ...
        CKEDITOR.tools = {arrayCompare: function (b, a) {
            ...
            for (var b = [].concat(b), a, e = [], i = 0; i < b.length; i++)if (a = b[i])/@import|[{}]/.test(a) ? e.push("<style>" + a + "</style>") : e.push('<link type="text/css" rel=stylesheet href="../../../admin_html_cms/vendors/ckeditor/' + a + '">');
            return e.join("")
