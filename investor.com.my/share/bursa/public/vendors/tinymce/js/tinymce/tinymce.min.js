...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        function t(n) {
            ...
            function T(e, t, n) {
                var i, o, a, s, l, c, d;
                for (n != I && (o = r()), i = A(e, n), o && o.appendChild(i), a = $(e), s = $(t), ++a, l = s - a, c = e.nextSibling; l > 0;)d = c.nextSibling, i = L(c, n), o && o.appendChild(i), c = d, --l;
            ...
            return j(M, {startContainer: H, startOffset: 0, endContainer: H, endOffset: 0, collapsed: F, commonAncestorContainer: H, START_TO_START: 0, START_TO_END: 1, END_TO_END: 2, END_TO_START: 3, setStart: i, setEnd: o, setStartBefore: a, setStartAfter: s, setEndBefore: l, setEndAfter: c, collapse: d, selectNode: u, selectNodeContents: f, compareBoundaryPoints: p, deleteContents: m, extractContents: h, cloneContents: g, insertNode: v, surroundContents: y, cloneRange: b, toStringIE: D}), M
        }
        ...
        return function (i, o) {
            ...
            i = i || {}, s.schema = o = o || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var s = this, l, c = 0, d, u, f = [], p, m, h, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, D, M, H, P, O, I = 0, F = t.decode, z, W = n.makeMap("src,href,data,background,formaction,poster"), V = /((java|vb)script|mhtml):/i, U = /^data:/i;
                for (M = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), H = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, b = o.getShortEndedElements(), D = i.self_closing_elements || o.getSelfClosingElements(), C = o.getBoolAttrs(), w = i.validate, y = i.remove_internals, z = i.fix_self_closing, P = o.getSpecialElements(); l = M.exec(e);) {
                    if (c < l.index && s.text(F(e.substr(c, l.index - c))), d = l[6])d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), r(d); else if (d = l[7]) {
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), x = d in b, z && D[d] && f.length > 0 && f[f.length - 1].name === d && r(d), !w || (_ = o.getElementRule(d))) {
                            if (N = !0, w && (S = _.attributes, T = _.attributePatterns), (k = l[8]) ? (v = -1 !== k.indexOf("data-mce-type"), v && y && (N = !1), p = [], p.map = {}, k.replace(H, a)) : (p = [], p.map = {}), w && !v) {
        ...
        return function (r, l) {
            ...
            r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", d.schema = l = l || new t, d.filterNode = function (e) {
                ...
                var v, y, b, C, x, w, _, N, E, k, S, T, R, A = [], B, L, D, M, H, P, O, I;
                if (o = o || {}, p = {}, m = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), P = l.children, S = r.validate, I = "forced_root_block"in o ? o.forced_root_block : r.forced_root_block, H = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, L = /[ \t\r\n]+$/, D = /[ \t\r\n]+/g, M = /^[ \t\r\n]+$/, v = new n({validate: S, allow_script_urls: r.allow_script_urls, allow_conditional_comments: r.allow_conditional_comments, self_closing_elements: g(l.getSelfClosingElements()), cdata: function (e) {
                    ...
                    var n;
                    B || (e = e.replace(D, " "), b.lastChild && T[b.lastChild.name] && (e = e.replace(R, ""))), 0 !== e.length && (n = d("#text", 3), n.raw = !!t, b.append(n).value = e)
                }, comment: function (e) {
                    ...
                    if (r = S ? l.getElementRule(t) : {}) {
                        if (T[t] && !B) {
                            ...
                            if (n = b.lastChild, n && 3 === n.type)if (i = n.value.replace(L, ""), i.length > 0)n.value = i, n = n.prev;
        ...
        return function (r, i) {
            ...
            function l(e, t, r) {
                ...
                g(), l = C.getPos(e, m), R = l.x, A = l.y, p = e.getBoundingClientRect(), d = p.width || p.right - p.left, u = p.height || p.bottom - p.top, w != e && (h(), w = e, H = P = 0), f = i.fire("ObjectSelected", {target: e}), o(e) && !f.isDefaultPrevented() ? x(N, function (e, o) {
                    function l(t) {
            ...
            function p(e) {
                ...
                for (r in N)if (o = N[r], a = t.offsetWidth * o[0], s = t.offsetHeight * o[1], Math.abs(a - c) < 8 && Math.abs(s - d) < 8) {
                    E = o;
                    break
                }
            ...
            var C = i.dom, x = t.each, w, _, N, E, k, S, T, R, A, B, L, D, M, H, P, O = i.getDoc(), I = document, F = n.ie && n.ie < 11;
        ...
        function n(e) {
            this.walk = function (t, n) {
                ...
                function s(e, t, r) {
                    ...
                    for (h = e, g = h.parentNode; h && h != t; h = g)g = h.parentNode, v = o(h == e ? h : h[a], a), v.length && (r || v.reverse(), n(i(v)))
                }
                ...
                if (1 == l.nodeType && l.hasChildNodes() && (l = l.childNodes[c]), 1 == d.nodeType && d.hasChildNodes() && (d = d.childNodes[Math.min(u - 1, d.childNodes.length - 1)]), l == d)return n(i([l]));
        ...
        return s.prototype = {setCursorLocation: function (e, t) {
            ...
            if (e)if (e.start) {
                ...
                t(!0) && t() && i.setRng(a)
            } else e.id ? (n("start"), n("end"), d && (a = o.createRng(), a.setStart(r(d), m), a.setEnd(r(p), h), i.setRng(a))) : e.name ? i.select(o.select(e.name)[e.index]) : e.rng && i.setRng(e.rng)
        }, select: function (e, t) {
        ...
        return function (i) {
            ...
            function m(t, n, r) {
                function a(e, t) {
                    t = t || h, e && (t.onformat && t.onformat(e, t, n, r), nt(t.styles, function (t, r) {
                ...
                function u(e, r, i) {
                    ...
                    d = h.inline || h.block, u = z.create(d), a(u), V.walk(e, function (e) {
                        function m(e) {
                            var y, C, x, w, _;
                            return _ = p, y = e.nodeName.toLowerCase(), C = e.parentNode.nodeName.toLowerCase(), 1 === e.nodeType && Z(e) && (_ = p, p = "true" === Z(e), w = !0), N(y, "br") ? (g = 0, void(h.block && z.remove(e))) : h.wrapper && v(e, t, n) ? void(g = 0) : p && !w && h.block && !h.wrapper && o(y) && U(C, d) ? (e = z.rename(e, d), a(e), l.push(e), void(g = 0)) : h.selector && (nt(f, function (t) {
                        ...
                        function t(e) {
                            var n, r, i;
                            if ("A" === e.nodeName) {
                                for (r = z.clone(u, G), l.push(r), i = rt(e.childNodes), n = 0; n < i.length; n++)r.appendChild(i[n]);
                                e.appendChild(r)
                            }
                        ...
                        if (h.inline || h.wrapper) {
                            ...
                            }), e && h.merge_siblings !== !1 && (e = H(D(e), e), e = H(e, D(e, X)))
                        }
                    })
                }

                var f = d(t), h = f[0], g, y, b = !r && W.isCollapsed();
                if (h)if (r)r.nodeType ? (y = z.createRng(), y.setStartBefore(r), y.setEndAfter(r), u(A(y, f), null, !0)) : u(r, null, !0); else if (b && h.inline && !z.select("td.mce-item-selected,th.mce-item-selected").length)O("apply", t, n); else {
                ...
                function s(e, n, r, i) {
                    ...
                    if (e) {
                        for (d = e.parentNode, o = n.parentNode; o && o != d; o = o.parentNode) {
                            for (a = z.clone(o, G), c = 0; c < p.length; c++)if (B(p[c], t, a, a)) {
                                a = 0;
                                break
                            }
                ...
                function i(e, t, i) {
                    ...
                    if (s)if (s.length === Q) {
                        for (o in s)if (s.hasOwnProperty(o)) {
                            ...
                            if ((!r || t.exact) && !N(a, k(S(s[o], n), o)))return
                        }
            ...
            function A(t, n, r) {
                ...
                function d(t, n, o) {
                    ...
                    for (s = new e(t, z.getParent(t, q) || i.getBody()); l = s[o ? "prev" : "next"]();)if (3 === l.nodeType) {
                        if (d = l, c = a(l), -1 !== c)return{container: l, offset: c}
                    } else if (q(l))break;
            ...
            function B(e, t, n, r) {
                ...
                if ("all" != e.remove)for (nt(e.styles, function (e, i) {
                    e = k(S(e, t), i), "number" == typeof i && (i = e, r = 0), (!r || N(E(r, i), e)) && z.setStyle(n, i, ""), a = 1
                }), a && "" === z.getAttrib(n, "style") && (n.removeAttribute("style"), n.removeAttribute("data-mce-style")), nt(e.attributes, function (e, i) {
                    var o;
                    if (e = S(e, t), "number" == typeof i && (i = e, r = 0), !r || N(z.getAttrib(r, i), e)) {
                ...
                }), o = z.getAttribs(n), i = 0; i < o.length; i++)if (0 !== o[i].nodeName.indexOf("_"))return G;
                return"none" != e.remove ? (L(n, e), X) : void 0
            }

            function L(e, t) {
                function n(e, t, n) {
                    return e = D(e, t, n), !e || "BR" == e.nodeName || q(e)
                }

                var r = e.parentNode, o;
                t.block && (j ? r == z.getRoot() && (t.list_block && N(e, t.list_block) || nt(rt(e.childNodes), function (e) {
                    U(j, e.nodeName.toLowerCase()) ? o ? o.appendChild(e) : (o = R(e, j), z.setAttribs(o, i.settings.forced_root_block_attrs)) : o = 0
                })) : q(e) && !q(r) && (n(e, G) || n(e.firstChild, X, 1) || e.insertBefore(z.create("br"), e.firstChild), n(e, X) || n(e.lastChild, G, 1) || e.appendChild(z.create("br")))), t.selector && t.inline && !N(t.inline, e) || z.remove(e, 1)
            }
                ...
                function n(e, t) {
                    ...
                    function r(e, t) {
                        ...
                        for (r in e)if (e.hasOwnProperty(r)) {
                            if (n = t[r], n === Q)return G;
                            if (e[r] != n)return G;
                            delete t[r]
                        }
                        for (r in t)if (t.hasOwnProperty(r))return G;
                        return X
                    }
            ...
            function O(t, n, r) {
                ...
                function u(e, t) {
                    var n, r;
                    if (e)r = W.getRng(!0), s(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), z.remove(e)) : (n = c(e), n.nodeValue.charAt(0) === K && (n = n.deleteData(0, 1)), z.remove(e, 1)), W.setRng(r); else if (e = l(W.getStart()), !e)for (; e = z.get(y);)u(e, !1)
                }
                ...
                function p() {
                    ...
                    if (u)if (l)s = W.getBookmark(), e.collapse(!0), e = A(e, d(n), !0), e = V.split(e), h(n, r, e), W.moveToBookmark(s); else {
                        for (m = a(), c = m, p = f.length - 1; p >= 0; p--)c.appendChild(z.clone(f[p], !1)), c = c.firstChild;
            ...
            function I(t) {
                ...
                if (3 == n.nodeType && r >= n.nodeValue.length && (r = $(n), n = n.parentNode, i = !0), 1 == n.nodeType)for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, z.getParent(n, z.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next())if (3 == a.nodeType && !T(a))return l = z.create("a", null, K), a.parentNode.insertBefore(l, a), t.setStart(a, 0), W.setRng(t), void z.remove(l)
            }
        ...
        return function (i) {
            function o(o) {
                ...
                function h(t) {
                    ...
                    } else"BR" == t.nodeName ? t.nextSibling && a.isBlock(t.nextSibling) ? ((!L || 9 > L) && (d = a.create("br"), t.parentNode.insertBefore(d, t)), l.setStartBefore(t), l.setEndBefore(t)) : (l.setStartAfter(t), l.setEndAfter(t)) : (l.setStart(t, 0), l.setEnd(t, 0));
                ...
                var k, S, T, R, A, B, L, D, M, H, P, O, I, F, z;
                if (k = s.getRng(!0), !o.isDefaultPrevented()) {
                    if (!k.collapsed)return void i.execCommand("Delete");
                    if (new t(a).normalize(k), R = k.startContainer, A = k.startOffset, F = (l.force_p_newlines ? "p" : "") || l.forced_root_block, F = F ? F.toUpperCase() : "", L = a.doc.documentMode, D = o.shiftKey, 1 == R.nodeType && R.hasChildNodes() && (z = A > R.childNodes.length - 1, R = R.childNodes[Math.min(A, R.childNodes.length - 1)] || R, A = z && 3 == R.nodeType ? R.nodeValue.length : 0), T = N(R)) {
                        if (c.beforeChange(), !a.isBlock(T) && T != a.getRoot())return void((!F || D) && w());
                        if ((F && !D || !F && D) && (R = b(R, A)), B = a.getParent(R, a.isBlock), P = B ? a.getParent(B.parentNode, a.isBlock) : null, O = B ? B.nodeName.toUpperCase() : "", I = P ? P.nodeName.toUpperCase() : "", "LI" != I || o.ctrlKey || (B = P, O = I), "LI" == O) {
                            if (!F && D)return void w();
                            if (a.isEmpty(B))return void C()
                        }
                        if ("PRE" == O && l.br_in_pre !== !1) {
                            if (!D)return void w()
                        } else if (!F && !D && "LI" != O || F && D)return void w();
        ...
        return function (r) {
            ...
            o(this, {execCommand: p, queryCommandState: m, queryCommandValue: h, addCommands: g}), g({"mceResetDesignMode,mceBeginUndoLevel": function () {
                ...
                /^ | $/.test(i) && (i = o(i)), a = r.parser, s = new e({}, r.schema), v = '<span id="mce_marker" data-mce-type="bookmark">﻿ÈB;</span>', f = {content: i, format: "html", selection: !0}, r.fire("BeforeSetContent", f), i = f.content, -1 == i.indexOf("{$caret}") && (i += "{$caret}"), i = i.replace(/\{\$caret\}/, v), m = _.getRng();
    ...
    }), r(U, [F, f, W, V], function (e, t, n, r) {
        var i = t.makeMap("focusin focusout scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave wheel keydown keypress keyup contextmenu", " "), o = {}, a = "onmousewheel"in document, s = !1, l = "mce-", c = e.extend({Statics: {elementIdCache: o, classPrefix: l}, isRtl: function () {
            return c.rtl
            ...
            var r = this, o, a, s, l;
            if (t)for ("string" == typeof t && (t = n(t)), s = e.toLowerCase().split(" "), l = s.length; l--;)e = s[l], o = r._bindings, o || (o = r._bindings = {}), a = o[e], a || (a = o[e] = []), a.push(t), i[e] && (r._nativeEvents || (r._nativeEvents = {}), r._nativeEvents[e] = !0, r._rendered && r.bindPendingEvents());
            return r
        }, off: function (e, t) {
            ...
            var t = this, r, i = new n;
            for (r = t.parent(); r; r = r.parent())i.add(r);
            return e && (i = i.filter(e)), i
        }, parentsAndSelf: function (e) {
            return new n(this).add(this.parents(e))
        }, next: function () {
            ...
            if (o._rendered = !0, f = o._nativeEvents) {
                ...
                for (p in f) {
                    if (!f)return!1;
                    "wheel" !== p || s ? ("mouseenter" === p || "mouseleave" === p ? u._hasMouseEnter || (r.on(u.getEl(), "mouseleave", t), r.on(u.getEl(), "mouseover", n), u._hasMouseEnter = 1) : m[p] || (r.on(u.getEl(), p, e), m[p] = !0), f[p] = !1) : a ? r.on(o.getEl(), "mousewheel", i) : r.on(o.getEl(), "DOMMouseScroll", i)
                }
            }
        }, getRoot: function () {
    ...
    }), r($, [U, W, z, q, j, f, V], function (e, t, n, r, i, o, a) {
        var s = {};
    ...
    }), r(nt, [T, A, C, m, h, f], function (e, t, n, r, i, o) {
        return function (a) {
            function s(e, t) {
                try {
            ...
            function d() {
                ...
                var n = a.getDoc(), r = "data:text/mce-internal,", i = window.MutationObserver, s;
                i || (s = !0, i = function () {
                    function e(e) {
                    ...
                    if (!c(e)) {
                        ...
                        i = unescape(i.substr(r.length)), n.caretRangeFromPoint && (e.preventDefault(), t(), a.selection.setRng(n.caretRangeFromPoint(e.x, e.y)), a.insertContent(i))
                    }
                }), a.on("cut", function (e) {
            ...
            C(), _(), u(), L(), J && (d(), p(), g(), k(), z(), i.iOS ? (y(), M(), H(), F()) : f()), X && i.ie < 11 && (m(), b(), x(), w(), T(), R(), A(), B()), i.ie >= 11 && (H(), I()), i.ie && (f(), O()), G && (m(), h(), v(), N(), E(), S(), D(), P())
        }
    }), r(rt, [f], function (e) {
        function t() {
            return!1
        ...
        return{fire: function (e, i, o) {
            ...
            if (e = e.toLowerCase(), i = i || {}, i.type = e, !a.removed || "remove" === e) {
                if (i.target || (i.target = a), i.preventDefault || (i.preventDefault = function () {
            ...
            if (t === !1 && (t = function () {
                return!1
            }), t)for (l = e.toLowerCase().split(" "), c = l.length; c--;)e = l[c], a = o[r], a || (a = o[r] = {}), s = a[e], s || (s = a[e] = [], o.bindNative && i[e] && o.bindNative(e)), n ? s.unshift(t) : s.push(t);
            return o
        }, off: function (e, t) {
    ...
    }), r(ot, [v, b, C, k, E, B, D, M, H, P, O, I, y, d, tt, x, _, nt, h, f, rt, it], function (e, n, r, i, o, a, s, l, c, d, u, f, p, m, h, g, v, y, b, C, x, w) {
        function _(e, t) {
        ...
        var E = e.DOM, k = n.ThemeManager, S = n.PluginManager, T = C.extend, R = C.each, A = C.explode, B = C.inArray, L = C.trim, D = C.resolve, M = m.Event, H = b.gecko, P = b.ie;
        return N.prototype = {render: function () {
            ...
            for (t.iframeHTML = n.doctype + "<html><head>", n.document_base_url != t.documentBaseUrl && (t.iframeHTML += '<base href="../../../../../admin_html_cms/vendors/tinymce/js/tinymce/' + t.documentBaseURI.getURI() + '" />'), !b.caretAfter && n.ie7_compat && (t.iframeHTML += '<meta http-equiv="X-UA-Compatible" content="IE=7" />'), t.iframeHTML += '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />', m = 0; m < t.contentCSS.length; m++) {
                var g = t.contentCSS[m];
                t.iframeHTML += '<link type="text/css" rel="stylesheet" href="../../../../../admin_html_cms/vendors/tinymce/js/tinymce/' + g + '" />', t.loadedCSS[g] = !0
            }
            ...
            if (!e) {
                if (o = r.getRng(), o.item && (a = o.item(0)), n._refreshContentEditable(), i || (b.opera || n.getBody().focus(), n.getWin().focus()), H || i) {
            ...
            !e.initialized || e.settings.disable_nodechange || e.settings.readonly || (i = e.getBody(), n = t.getStart() || i, n = P && n.ownerDocument != e.getDoc() ? e.getBody() : n, "IMG" == n.nodeName && t.isCollapsed() && (n = n.parentNode), r = [], e.dom.getParent(n, function (e) {
            ...
            if (n && t.initialized)return e = e || {}, e.save = !0, e.element = n, r = e.content = t.getContent(e), e.no_events || t.fire("SaveContent", e), r = e.content, /TEXTAREA|INPUT/i.test(n.nodeName) ? n.value = r : (t.inline || (n.innerHTML = r), (i = E.getParent(t.id, "form")) && R(i.elements, function (e) {
            ...
            var e = this;
            if (!e.removed) {
                e.removed = 1, e.save(), e.hasHiddenInput && E.remove(e.getElement().nextSibling), e.inline || (P && 10 > P && e.getDoc().execCommand("SelectAll", !1, null), E.setStyle(e.id, "display", e.orgDisplay), e.getBody().onload = null, M.unbind(e.getWin()), M.unbind(e.getDoc()));
                var t = e.getContainer();
                M.unbind(e.getBody()), M.unbind(t), e.fire("remove"), e.editorManager.remove(e), E.remove(t), e.destroy()
            }
        ...
        function n(e) {
            ...
            function f(n) {
                var f = n.editor;
                f.on("init", function () {
                    (f.inline || t.ie) && (f.on("nodechange keyup", function () {
                        var e = document.activeElement;
                        e && e.id == f.id + "_ifr" && (e = f.getBody()), u(e, f) && (f.lastRng = f.selection.getRng())
                    ...
                    f.selection.lastFocusBookmark && (f.selection.setRng(c(f, f.selection.lastFocusBookmark)), f.selection.lastFocusBookmark = null), t != f && (t && t.fire("blur", {focusedEditor: f}), e.activeEditor = f, e.focusedEditor = f, f.fire("focus", {blurredEditor: t}), f.focus(!0)), f.lastRng = null
                }), f.on("focusout", function () {
                    window.setTimeout(function () {
                        var t = e.focusedEditor;
                        d(s()) || t != f || (f.fire("blur", {focusedEditor: null}), e.focusedEditor = null, f.selection && (f.selection.lastFocusBookmark = null))
                    }, 0)
                }), i || (i = function (t) {
                ...
                }, a.bind(document, "focusin", i)), f.inline && !o && (o = function (t) {
                    var n = e.activeEditor;
                    if (n.inline && !n.dom.isChildOf(t.target, n.getBody())) {
                        var r = n.selection.getRng();
                        r.collapsed || (n.lastRng = n.selection.getRng(), n.selection.lastFocusBookmark = l(n.dom, n.lastRng))
                    }
    ...
    }), r(lt, [ot, v, I, h, f, rt, at, st], function (e, t, n, r, i, o, a, s) {
        var l = t.DOM, c = i.explode, d = i.each, u = i.extend, f = 0, p, m = {majorVersion: "4", minorVersion: "0.22", releaseDate: "2014-04-16", editors: [], i18n: a, activeEditor: null, setup: function () {
            var e = this, t, r, i = "", o;
            if (r = document.location.href.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(r) || (r += "/"), o = window.tinymce || window.tinyMCEPreInit)t = o.base || o.baseURL, i = o.suffix; else for (var a = document.getElementsByTagName("script"), l = 0; l < a.length; l++) {
                var c = a[l].src;
            ...
            function n(e) {
                var t = e.id;
                return t || (t = e.name, t = t && !l.get(t) ? e.name : l.uniqueId(), e.setAttribute("id", t)), t
            }
            ...
            function o(e, t) {
                return t.constructor === RegExp ? t.test(e.className) : l.hasClass(e, t)
            }

            function a() {
                var h, g;
                if (l.unbind(window, "ready", a), i(t, "onpageload"), t.types)return void d(t.types, function (e) {
                    d(l.select(e.selector), function (i) {
                        r(n(i), u({}, t, e))
                    })
                });
                if (t.selector)return void d(l.select(t.selector), function (e) {
                    r(n(e), t)
                });
                switch (t.mode) {
                    case"exact":
                        h = t.elements || "", h.length > 0 && d(c(h), function (n) {
                            l.get(n) ? (m = new e(n, t, s), p.push(m), m.render()) : d(document.forms, function (e) {
                                d(e.elements, function (e) {
                                    e.name === n && (n = "mce_editor_" + f++, l.setAttrib(e, "id", n), r(n, t))
                                })
                            })
                        });
                        break;
                    ...
                    case"specific_textareas":
                        d(l.select("textarea"), function (e) {
                            t.editor_deselector && o(e, t.editor_deselector) || (!t.editor_selector || o(e, t.editor_selector)) && r(n(e), t)
                        })
                }
                t.oninit && (h = g = 0, d(p, function (e) {
                    g++, e.initialized ? h++ : e.on("init", function () {
                        h++, h == g && i(t, "oninit")
                    }), h == g && i(t, "oninit")
                }))
            }
            ...
            var s = this, p = [], m;
            s.settings = t, l.bind(window, "ready", a)
        }, get: function (e) {
            return arguments.length ? e in this.editors ? this.editors[e] : null : this.editors
        }, add: function (e) {
            var t = this, n = t.editors;
            return n[e.id] = e, n.push(e), t.activeEditor = e, t.fire("AddEditor", {editor: e}), p || (p = function () {
                t.fire("BeforeUnload")
            }, l.bind(window, "beforeunload", p)), e
            ...
            {
                if (e) {
                    if ("string" == typeof e)return e = e.selector || e, void d(l.select(e), function (e) {
                        t.remove(r[e.id])
                    });
                    ...
                    return t.activeEditor == i && (t.activeEditor = r[0]), o && t.fire("RemoveEditor", {editor: i}), r.length || l.unbind(window, "beforeunload", p), i.remove(), i
                }
        ...
        return u(m, o), m.setup(), window.tinymce = window.tinyMCE = m, m
    }), r(ct, [lt, f], function (e, t) {
    ...
    }), r(ht, [v, d, y, b, f, h], function (e, t, n, r, i, o) {
    ...
    }), r(Ht, [U, bt, Q, f, lt, h], function (e, t, n, r, i, o) {
        function a(e) {
            function t(t, n) {
                return function () {
                    var r = this;
        ...
        return e.extend({recalc: function (e) {
            var t = e.settings, n, r, i, o, a, s, l, c, d, u, f, p, m, h, g, v, y, b, C, x, w, _, N = [], E = [], k, S, T, R;
            ...
            for (T = o.innerW - g.left - g.right, w = 0, u = 0; r > u; u++)w += N[u] + (u > 0 ? y : 0), T -= (u > 0 ? y : 0) + N[u];
    ...
    }), a([l, c, d, u, f, p, m, h, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, D, M, H, P, O, I, F, z, W, V, U, q, j, $, K, Y, G, X, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, dt, ut, ft, pt, mt, ht, gt, vt, yt, bt, Ct, xt, wt, _t, Nt, Et, kt, St, Tt, Rt, At, Bt, Lt, Dt, Mt, Ht, Pt, Ot, It, Ft, zt, Wt, Vt, Ut, qt, jt, $t, Kt, Yt, Gt, Xt, Jt, Qt])
}(this);