...
Class adminController extends BaseController{
    ...
    */
    ...
    public function media_news_list(){
        ...
        $number_of_record = Input::get('limit') ? Input::get('limit') : 100 ;
    ...
    public function media_news_new_save(){
        ...
        if(Input::get('date') != null){
            ...
            if (Input::hasFile('imgFile'))
            {
                ...
                $allowedExt = array('JPG', 'PNG', 'TIF', 'PDF', 'DOC', 'XLS', 'ODT', 'ODS');
                ...
                {
                  Session::put('success', 2);
                  Session::put('message', 'extension not allowed, try again');
    ...
    public function grabAllNews() {
         ...
         * 
         * http://www.theedgemarkets.com/en/content/search-results?query=ock%20bhd
         * 
        ...
        if($newpass == $newpassC)
        {
            if(strlen($newpass) >= 6 && strlen($newpass) <= 12)
            {
                ...
                if($result)
                {
                 ...
                 Session::put('success', 2);
                 Session::put('message', 'Password length not correct');
            }
        }
        else 
        {
                Session::put('success', 2);
                Session::put('message', 'Password Not Matching');
        }
