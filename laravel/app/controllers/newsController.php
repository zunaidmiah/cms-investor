...
Class newsController extends BaseController{
    ...
    */
    ...
    public function news_centre_latest_media_news(){
        ...
        $minYearDate = $mediaNews->getMinNews();//Get Min year of publish date
        $maxYearDate = $mediaNews->getMaxNews();//Get Max year of publish date
        $getValidYearsList = $mediaNews->getValidYearsList();//Get Published News Years Only
        
        //$year = (Input::get('year') != null) ? Input::get('year') : date('Y', time()) ;
        $year = (Input::get('year') != null) ? Input::get('year') : date('Y', $maxYearDate) ;
        ...
        $data['year'] = $year;
        $data['minYearDate'] = date('Y', $minYearDate);
        $data['maxYearDate'] = date('Y', $maxYearDate);
        $data['getValidYearsList'] = $getValidYearsList;
