...
function scrapMediaNews() {
    ...
    get_curl_data(Config::get('app.laravel') . 'webscraper/grabAllDataCron');
    //Write log OR in Database
}

function sendMail() {
    get_curl_data(Config::get('app.laravel') . 'webscraper/sendMail');
}

function sendTestMail() {
    get_curl_data(Config::get('app.laravel') . 'webscraper/sendTestMail');
}
