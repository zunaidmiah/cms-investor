                ...
                <div class="portlet">
                        ...
                        <div class="modal-body">
                          <div class="form">
                            <form class="form-horizontal">
                              ...
                              <div class="form-actions">
                                <div class="col-md-offset-5 col-md-8"> <a href="#" class="btn btn-red send_news_email_btn">Send &nbsp;<i class="fa fa-share"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                              </div>
                            </form>
                          </div>
                        </div>
                  ...
                  <div class="portlet-body">
                    ...
                    {{ Form::open(array('id'=>'media_news_list', 'name'=>'media_news_list', 'action' => 'adminController@media_news_delete_all', 'method'=>'post', 'class'=>'selectionForm')) }}
                      ...
                      ?>
                    <div class="pull-right">Last updated: <span class="text-blue">{{ date('d M, Y @ h.iA', mktime($lastUpdatedNewsExplodedTimeArray[0], $lastUpdatedNewsExplodedTimeArray[1], $lastUpdatedNewsExplodedTimeArray[2], $lastUpdatedNewsExplodedDateArray[1], $lastUpdatedNewsExplodedDateArray[2], $lastUpdatedNewsExplodedDateArray[0])) }}</span></div>
