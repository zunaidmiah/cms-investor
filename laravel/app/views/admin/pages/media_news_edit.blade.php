                            ...
                            <div class="portlet-header">
									...
									<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                        	<div class="col-md-12">
                                                                ...
                                                                <br/>
                                                                <div class="well well-large alert-dismissable pull-left" style="display: block;">
                                                                    {{ Form::hidden('news_image', $mediaNews->news_image) }}
                                                                    <button type="button" data-dismiss="alert" aria-hidden="true" class="close pull-right" style="margin-top: -20px; color: #F00;">
                                                                        <i class="fa fa-times-circle"></i>
                                                                    </button>
                                                                    <p style="margin: 0;">
                                                                    <!--<img src="/{{ $mediaNews->news_image }}" style="max-width:300px; width:auto;">-->
                                                                        <img src="{{ URL::to('/').'/'.$mediaNews->news_image }}" style="max-width:300px; width:auto;">
                                                                    </p>
                                                                </div>
                                                                @endif
                                                            </div>
                                        ...
                                        <div class="form-actions none-bg">
                                                        ...
                                                        &nbsp;<a href="{{ URL::to(Session::get('REFERER')) }}" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a>
                                                        @else
