...
<script type="text/javascript" src="{{ URL::asset('js/modalPopup.js') }}"></script>
   ...
   <div class="row">
              <div class="col-lg-12">
                ...
                <div class="alert alert-danger alert-dismissable displaynone" style="display:none">
                    <button type="button" data-dismiss="alert" aria-hidden="true" class="close">&times;</button>
                ...
                <div class="portlet">
                  <div class="portlet-header"> 
                  	<a href="{{ URL::route('media_news_new', [], true) }}" class="btn btn-success">Add New &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                    <div class="btn-group">
...
<li><a href="#" onclick="MyFunction();return false;">Delete selected item(s)</a></li>
                    ...
                    &nbsp;<a href="#"  class="btn btn-orange check_selected_news">Select News &amp; Email &nbsp;<i class="fa fa-envelope"></i></a>&nbsp;
                    ...
                    <!-- modal delete all items end -->
                     <!--Modal select & email start-->
                  <div id="modal-select-email" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog modal-wide-width">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                          <h4 id="modal-login-label2" class="modal-title">Select News &amp; Email</h4>
                        </div>
                        <div class="modal-body">
                          <div class="form">
                            <form class="form-horizontal">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6">
                                  <input name="email_news_select_1"  type="text" class="form-control email_news_select">
                                </div>
                              </div>
                              <div class="more-email-container" >
                             
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"></label>
                                <div class="col-md-6">
                                  <a href="#" class="btn btn-success add_new_email ">Add New Email &nbsp;<i class="fa fa-plus"></i></a>
                                </div>
                              </div>
                              ...
                              <div class="form-actions">
                                <div class="col-md-offset-5 col-md-8"> <a href="#" class="btn btn-red send_news_email_btn" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing">Send &nbsp;<i class="fa fa-share"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                              </div>
                            </form>
                          </div>
                        </div>
                  ...
                  <div class="portlet-body">
                    ...
                    {{ Form::open(array('id'=>'media_news_list', 'name'=>'media_news_list', 'action' => 'adminController@media_news_delete_all', 'method'=>'post', 'class'=>'selectionForm')) }}
                      ...
                      <?php
                      if(isset($lastUpdatedNews)){
                      	$lastUpdatedNewsExploded = explode(' ', $lastUpdatedNews);
                      	$lastUpdatedNewsExplodedDateArray = explode('-', $lastUpdatedNewsExploded[0]);
                      	$lastUpdatedNewsExplodedTimeArray = explode(':', $lastUpdatedNewsExploded[1]);
                      }
                      ?>
                    <div class="pull-right">Last updated: <span class="text-blue">
                    @if(isset($lastUpdatedNews))
                    {{ date('d M, Y @ h.iA', mktime($lastUpdatedNewsExplodedTimeArray[0], $lastUpdatedNewsExplodedTimeArray[1], $lastUpdatedNewsExplodedTimeArray[2], $lastUpdatedNewsExplodedDateArray[1], $lastUpdatedNewsExplodedDateArray[2], $lastUpdatedNewsExplodedDateArray[0])) }}
                    @else
                    	{{ 'Unknown' }}
                    @endif
                    ...
                    <table class="table table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="{{ URL::route('media_news_edit', ['id'=>$mediaNew->id], true) }}">{{ stripslashes($mediaNew->title) }}</a></td>
                          <td>{{$mediaNew->footer}}</td>
                          <td>@if($mediaNew->email_sent)
                          <i class="fa fa-check"></i>
                          @endif 
                          </td>
                          <td>
                          	<a href="{{ URL::route('media_news_edit', ['id'=>$mediaNew->id], true) }}" data-hover="tooltip" data-placement="top" title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>
                          	<a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-{{$mediaNew->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a> 
                          	<a href="{{ URL::to('admin/publishNews?publish='.$mediaNew->id) }}" data-hover="tooltip" data-placement="top" title="Publish"><span class="label label-sm label-blue"><i class="fa fa-globe"></i></span></a>
                              <!--Modal delete start-->
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      ...
                                      <div class="form-actions">
                                        <div class="col-md-offset-4 col-md-8"> <a href="{{ URL::route('media_news_delete', ['id'=>$mediaNew->id], true) }}" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                      </div>
                                    </div>
                                  </div>
                                </div>
