...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <style type="text/css">
         <!--                                                a {                            color: #b8312f;text-decoration: none;outline: none;                        }                        a:hover {                            color: #3a87ad;                            text-decoration: none;                        }                        -->
      </style>
   </head>
         ...
         <tr>
            <td>
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                     <td>
                        <h2 style="font-size:28px; line-height: 36px; font-family: Arial, sans-serif; color:#333; ">Media News Email</h2>
                     </td>
                              ...
                              <table width="100%" cellpadding="8">
                                 <tbody>
                                    <tr bgcolor="#f5f5f5">
                                       ...
                                       <td>
                                          <div style="display: inline-block; margin-bottom: 0; font-family: 'Open Sans', sans-serif; font-size: 16px; font-weight: 400; text-align: center; vertical-align: middle; border: 1px solid transparent; padding: 6px 12px; color: #fff; background-color: #f0ad4e; border-color: #eea236">Pending for Approval</div>
                                       </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr bgcolor="#f5f5f5">
                                       ...
                                       <td>
                                          <span style="font-family: 'Open Sans', sans-serif; font-size: 16px; color:#777;">{{ $source }}</span><br/><!-- <a style="font-family: 'Open Sans', sans-serif; size: 16px; color: #b8312f;text-decoration: none;outline: none;" href="http://www.thestar.com.my" target="_blank">http://www.thestar.com.my</a>-->
                                       </td>
                                    </tr>
                                 </tbody>
                              </table>
                           ...
                           <div style="background: #FFFFFF; padding: 15px; border-bottom-left-radius: 5px; border-bottom-right-radius: 5px;">
                              <table width="100%">
                                 <tbody>
                                    <tr>
                                       <td>
                                          <h2 style="color: #cc0000; font-size:28px; line-height: 36px; font-family: Arial, Helvetica, sans-serif; ">{{ stripslashes($value->title) }}</h2>
