   ...
   {{-- <li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/corporategovernance') }}">Corporate Governance</a></li>--}}
	 ...
	 <li class="menu-item"><a href="#">Policies</a>
        <ul class="sub-menu">
           ...
           <li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/managementanalysis/directorsfitandproperpolicy') }}">Directors’ Fit and Proper Policy</a></li>
		   <li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/managementanalysis/externalauditorsassessmentpolicy') }}">External Auditors Assessment Policy</a></li>
		   <li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/managementanalysis/genderdiversitypolicy') }}">Gender Diversity Policy</a></li>
           <li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/managementanalysis/remunerationpolicy') }}">Remuneration Policy</a></li>
           <li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/managementanalysis/whistleblowerpolicy') }}">Whistleblowing Policy</a></li>
...
<li class="menu-item"><a href="#">Terms of Reference</a>
	<ul class="sub-menu">
        ...
        <li class="menu-item"><a href="{{ URL::to('bursa/sustainability/tor-risk-management-committee') }}">Audit & Risk Management Committee</a></li>
...
<li class="menu-item current-menu-item menu-item-home"><a href="{{ URL::to('bursa/investorrelations/reports/prospectus') }}">AGM/EGM</a></li>
<!--<li class=" menu-item menu-item-has-children arrow"><a href="{{ URL::to('bursa/investorrelations/reports/prospectus') }}">AGM/EGM</a>-->
	<!--<ul class="sub-menu">
    <li class="menu-item menu-item-has-children"><a href="#">Corporate Information</a>
    <ul class="sub-menu">
        <li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/corporateinformation/general') }}">Statutory Information</a></li>
        <<li class="menu-item"><a href="{{ URL::to('board') }}">Board of Directors</a></li>
        <li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/corporateinformation/keymanagemnet') }}">Key Senior Management</a></li>
		<li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/reports/prospectus') }}">AGM/EGM</a></li>
    </ul>
    </li>-->
<li class=" menu-item menu-item-has-children arrow"><a href="{{ URL::to('bursa') }}">Investor Relations</a>
    ...
    <ul class="sub-menu">
        <li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/shareinformation/priceticker')}}">Stock Quote</a></li>
...
<li class="menu-item menu-item-has-children"><a href="#">News Centre</a>
    <ul class="sub-menu">
        ...
        <li class="menu-item"><a href="{{ URL::to('media') }}">Media News</a></li>
...
<li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/managementanalysis/summaryofshareholdersvotingrights') }}">Summary of Shareholders' Voting Rights</a></li>
<li class="menu-item"><a href="{{ URL::to('bursa/investorrelations/managementanalysis/edividend') }}">eDividend</a></li>
