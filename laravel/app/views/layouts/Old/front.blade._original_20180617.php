                            ...
                            <ul id="menu" class="sf-menu">
                                ...
                                <li>
                                	...
                                	<ul>                                  
                                        ...
                                        <li><a href="{{ URL::to('/pages/news_events') }}">Company Bulletin</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a href="#">LINKS</a>
                                	<ul>
                                       <li><a href="http://bursa.fareastholdingsbhd.com/contactus">Related Palm Oil Agencies</a></li>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                       <ul class="contact_footer">
                         ...
                         <li>&copy; 2016 Far East Holdings Berhad (14809-W). All Rights Reserved. <a href="http://www.webqom.com/web_design.html" target="_blank">Web Design Malaysia</a> &amp; <a href="http://www.webqom.com/web_hosting.html" target="_blank">Web Hosting Malaysia</a> </li>       
                        </ul>
                    </div>
                    <!-- Contact Us-->
                </div>
