                                ...
                                <div id="dec">
                                    @if(!empty($Dec))
                                        ...
                                        <div class="span6">
                                            ...
                                            <blockquote>
                                                @if(!empty($evenValue->date))<div class="label label-info">{{ date('d M, Y', $evenValue->date) }}</div>@endif <a href="{{ URL::to('news/news_centre_latest_media_news_details?show='.$evenValue->id) }}" target="_blank">{{ stripslashes($evenValue->title) }}</a> 
