...
$(function(){
    ...
    $("#corporate_information_page_edit, #corporate_information_page_new").submit(function(event){
       
        //event.preventDefault();
        // alert("eeee");

        var heading3             = $(".red-title3").html();
        var body3                = $("#body3").html();
        
     
        $(this).find('input[name="heading3"]').val(heading3); 
        $(this).find('input[name="body3"]').val(body3);
        //
     });
     $('#save_page_content_form').click(function(event){
         $("#corporate_information_page_edit").submit();
     });
    ...
    $("#BottomMontages_edit_form").submit(function(event){
        var body  = $("#mon_body_edit").html();
        $(this).find('input[name="mon_body"]').val(body); 
     });
