...
This code is for the the checkbox functionailty in the indes_edit.bladde.php
*****/

$(document.body).on("change",".maincheckbox",function(){
...
This code is  for file upload change avatar

*****/

$(document.body).on("click","#upload_file",function(e){
   ...
   // e.preventDefault();
    if($("#avatarfile").val() != ""){
        ...
        formobject.append('avatarfile', file);
          var $this = $(this);
            $this.button('loading');
        ...
        $.ajax({
            ...
            success: function (e) {
                ...
                $("#upload_msg").text("Successfully Uploaded Avatar");
                $("#alertdiv").removeClass("hide");
                window.location.reload();
            },
            error: function (e) {
                $("#alertdiv").addClass("alert-danger");
                $("#upload_msg").text("rror occurred try again");
                $("#alertdiv").removeClass("hide");
                  $this.button('reset');
            }
